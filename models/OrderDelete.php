 ...
 * Page class
 */
class OrderDelete extends Order
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrderDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("OrderList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("OrderList"); // Return to list
            return;
        }
