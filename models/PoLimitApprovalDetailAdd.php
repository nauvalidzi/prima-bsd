 ...
 * Page class
 */
class PoLimitApprovalDetailAdd extends PoLimitApprovalDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoLimitApprovalDetailAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PoLimitApprovalDetailView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // idapproval
        $this->idapproval->setDbValueDef($rsnew, $this->idapproval->CurrentValue, null, false);
