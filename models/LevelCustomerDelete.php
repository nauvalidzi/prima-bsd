 ...
 * Page class
 */
class LevelCustomerDelete extends LevelCustomer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LevelCustomerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LevelCustomerList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LevelCustomerList"); // Return to list
                return;
            }
        }
