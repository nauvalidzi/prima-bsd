...
class Stocks extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('stocks', 'stocks', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // prop_id
        $this->prop_id = new DbField('stocks', 'stocks', 'x_prop_id', 'prop_id', '`prop_id`', '`prop_id`', 3, 11, -1, false, '`prop_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idproduct
        $this->idproduct = new DbField('stocks', 'stocks', 'x_idproduct', 'idproduct', '`idproduct`', '`idproduct`', 3, 11, -1, false, '`idproduct`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // stok_akhir
        $this->stok_akhir = new DbField('stocks', 'stocks', 'x_stok_akhir', 'stok_akhir', '`stok_akhir`', '`stok_akhir`', 3, 11, -1, false, '`stok_akhir`', false, false, false, 'FORMATTED TEXT', 'TEXT');
