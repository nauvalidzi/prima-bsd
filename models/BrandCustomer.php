...
/**
 * Table class for brand_customer
 */
class BrandCustomer extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'brand_customer';
        $this->TableName = 'brand_customer';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`brand_customer`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BrandCustomerList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "BrandCustomerEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BrandCustomerAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BrandCustomerView";
            case Config("API_ADD_ACTION"):
                return "BrandCustomerAdd";
            case Config("API_EDIT_ACTION"):
                return "BrandCustomerEdit";
            case Config("API_DELETE_ACTION"):
                return "BrandCustomerDelete";
            case Config("API_LIST_ACTION"):
                return "BrandCustomerList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BrandCustomerView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BrandCustomerView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BrandCustomerAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BrandCustomerAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BrandCustomerEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BrandCustomerAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BrandCustomerDelete", $this->getUrlParm());
    }
