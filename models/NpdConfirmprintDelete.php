 ...
 * Page class
 */
class NpdConfirmprintDelete extends NpdConfirmprint
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmprintDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdConfirmprintList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NpdConfirmprintList"); // Return to list
                return;
            }
        }
