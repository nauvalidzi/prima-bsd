 ...
 * Page class
 */
class StockDeliveryorderDetailDelete extends StockDeliveryorderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockDeliveryorderDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StockDeliveryorderDetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("StockDeliveryorderDetailList"); // Return to list
                return;
            }
        }
