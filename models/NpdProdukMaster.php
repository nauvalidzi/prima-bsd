...
/**
 * Table class for npd_produk_master
 */
class NpdProdukMaster extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'npd_produk_master';
        $this->TableName = 'npd_produk_master';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`npd_produk_master`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('npd_produk_master', 'npd_produk_master', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // grup
        $this->grup = new DbField('npd_produk_master', 'npd_produk_master', 'x_grup', 'grup', '`grup`', '`grup`', 200, 50, -1, false, '`grup`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kategori
        $this->kategori = new DbField('npd_produk_master', 'npd_produk_master', 'x_kategori', 'kategori', '`kategori`', '`kategori`', 200, 50, -1, false, '`kategori`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sediaan
        $this->sediaan = new DbField('npd_produk_master', 'npd_produk_master', 'x_sediaan', 'sediaan', '`sediaan`', '`sediaan`', 200, 50, -1, false, '`sediaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bentukan
        $this->bentukan = new DbField('npd_produk_master', 'npd_produk_master', 'x_bentukan', 'bentukan', '`bentukan`', '`bentukan`', 200, 50, -1, false, '`bentukan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // konsep
        $this->konsep = new DbField('npd_produk_master', 'npd_produk_master', 'x_konsep', 'konsep', '`konsep`', '`konsep`', 200, 50, -1, false, '`konsep`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bahanaktif
        $this->bahanaktif = new DbField('npd_produk_master', 'npd_produk_master', 'x_bahanaktif', 'bahanaktif', '`bahanaktif`', '`bahanaktif`', 200, 50, -1, false, '`bahanaktif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fragrance
        $this->fragrance = new DbField('npd_produk_master', 'npd_produk_master', 'x_fragrance', 'fragrance', '`fragrance`', '`fragrance`', 200, 50, -1, false, '`fragrance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // aroma
        $this->aroma = new DbField('npd_produk_master', 'npd_produk_master', 'x_aroma', 'aroma', '`aroma`', '`aroma`', 200, 50, -1, false, '`aroma`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // warna
        $this->warna = new DbField('npd_produk_master', 'npd_produk_master', 'x_warna', 'warna', '`warna`', '`warna`', 200, 50, -1, false, '`warna`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // aplikasi_sediaan
        $this->aplikasi_sediaan = new DbField('npd_produk_master', 'npd_produk_master', 'x_aplikasi_sediaan', 'aplikasi_sediaan', '`aplikasi_sediaan`', '`aplikasi_sediaan`', 200, 50, -1, false, '`aplikasi_sediaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // aksesoris
        $this->aksesoris = new DbField('npd_produk_master', 'npd_produk_master', 'x_aksesoris', 'aksesoris', '`aksesoris`', '`aksesoris`', 200, 50, -1, false, '`aksesoris`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nour
        $this->nour = new DbField('npd_produk_master', 'npd_produk_master', 'x_nour', 'nour', '`nour`', '`nour`', 3, 11, -1, false, '`nour`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated_at
        $this->updated_at = new DbField('npd_produk_master', 'npd_produk_master', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, false, '`updated_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`npd_produk_master`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NpdProdukMasterList");
    }
    ...
    {
        global $Language;
        if ($pageName == "NpdProdukMasterView") {
            return $Language->phrase("View");
        } elseif ($pageName == "NpdProdukMasterEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "NpdProdukMasterAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NpdProdukMasterView";
            case Config("API_ADD_ACTION"):
                return "NpdProdukMasterAdd";
            case Config("API_EDIT_ACTION"):
                return "NpdProdukMasterEdit";
            case Config("API_DELETE_ACTION"):
                return "NpdProdukMasterDelete";
            case Config("API_LIST_ACTION"):
                return "NpdProdukMasterList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NpdProdukMasterView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("NpdProdukMasterView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "NpdProdukMasterAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "NpdProdukMasterAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdProdukMasterEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdProdukMasterAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("NpdProdukMasterDelete", $this->getUrlParm());
    }
