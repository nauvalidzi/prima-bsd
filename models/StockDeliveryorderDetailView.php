 ...
 * Page class
 */
class StockDeliveryorderDetailView extends StockDeliveryorderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockDeliveryorderDetailView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "StockDeliveryorderDetailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "StockDeliveryorderDetailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "StockDeliveryorderDetailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
