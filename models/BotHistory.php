...
/**
 * Table class for bot_history
 */
class BotHistory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'bot_history';
        $this->TableName = 'bot_history';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`bot_history`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`bot_history`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BotHistoryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "BotHistoryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "BotHistoryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BotHistoryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BotHistoryView";
            case Config("API_ADD_ACTION"):
                return "BotHistoryAdd";
            case Config("API_EDIT_ACTION"):
                return "BotHistoryEdit";
            case Config("API_DELETE_ACTION"):
                return "BotHistoryDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BotHistoryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BotHistoryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BotHistoryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BotHistoryAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("BotHistoryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BotHistoryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BotHistoryDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // prop_name
        $this->prop_name->EditAttrs["class"] = "form-control";
        $this->prop_name->EditCustomAttributes = "";
