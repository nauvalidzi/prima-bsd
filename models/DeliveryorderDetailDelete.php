 ...
 * Page class
 */
class DeliveryorderDetailDelete extends DeliveryorderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DeliveryorderDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DeliveryorderDetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("DeliveryorderDetailList"); // Return to list
            return;
        }
