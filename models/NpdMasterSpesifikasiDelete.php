 ...
 * Page class
 */
class NpdMasterSpesifikasiDelete extends NpdMasterSpesifikasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdMasterSpesifikasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdMasterSpesifikasiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NpdMasterSpesifikasiList"); // Return to list
                return;
            }
        }
