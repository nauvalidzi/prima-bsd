 ...
 * Page class
 */
class VPiutangDetailList extends VPiutangDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VPiutangDetailList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fv_piutang_detaillist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "VPiutangDetailDelete";
        $this->MultiUpdateUrl = "VPiutangDetailUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fv_piutang_detaillistsrch";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fv_piutang_detaillistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fv_piutang_detaillistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fv_piutang_detaillist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
