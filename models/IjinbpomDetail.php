...
class IjinbpomDetail extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('ijinbpom_detail', 'ijinbpom_detail', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->idnpd->Lookup = new Lookup('idnpd', 'npd', false, 'id', ["kodeorder","","",""], [], [], [], [], ["idproduct_acuan"], ["x_idproduct_acuan"], '', '');
                break;
            default:
                $this->idnpd->Lookup = new Lookup('idnpd', 'npd', false, 'id', ["kodeorder","","",""], [], [], [], [], ["idproduct_acuan"], ["x_idproduct_acuan"], '', '');
                break;
