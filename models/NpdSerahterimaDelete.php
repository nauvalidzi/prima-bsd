 ...
 * Page class
 */
class NpdSerahterimaDelete extends NpdSerahterima
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdSerahterimaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdSerahterimaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NpdSerahterimaList"); // Return to list
                return;
            }
        }
