 ...
 * Page class
 */
class KabupatenDelete extends Kabupaten
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KabupatenDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KabupatenList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KabupatenList"); // Return to list
                return;
            }
        }
