 ...
 * Page class
 */
class NpdMasterKemasanDelete extends NpdMasterKemasan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdMasterKemasanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdMasterKemasanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NpdMasterKemasanList"); // Return to list
                return;
            }
        }
