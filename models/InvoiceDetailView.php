 ...
 * Page class
 */
class InvoiceDetailView extends InvoiceDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvoiceDetailView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "InvoiceDetailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "InvoiceDetailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "InvoiceDetailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
