...
/**
 * Table class for stock_order_detail
 */
class StockOrderDetail extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'stock_order_detail';
        $this->TableName = 'stock_order_detail';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`stock_order_detail`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('stock_order_detail', 'stock_order_detail', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // pid
        $this->pid = new DbField('stock_order_detail', 'stock_order_detail', 'x_pid', 'pid', '`pid`', '`pid`', 21, 20, -1, false, '`pid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idbrand
        $this->idbrand = new DbField('stock_order_detail', 'stock_order_detail', 'x_idbrand', 'idbrand', '`idbrand`', '`idbrand`', 21, 20, -1, false, '`idbrand`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // idproduct
        $this->idproduct = new DbField('stock_order_detail', 'stock_order_detail', 'x_idproduct', 'idproduct', '`idproduct`', '`idproduct`', 21, 20, -1, false, '`idproduct`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // stok_akhir
        $this->stok_akhir = new DbField('stock_order_detail', 'stock_order_detail', 'x_stok_akhir', 'stok_akhir', '`stok_akhir`', '`stok_akhir`', 21, 20, -1, false, '`stok_akhir`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sisa
        $this->sisa = new DbField('stock_order_detail', 'stock_order_detail', 'x_sisa', 'sisa', '`sisa`', '`sisa`', 3, 11, -1, false, '`sisa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jumlah
        $this->jumlah = new DbField('stock_order_detail', 'stock_order_detail', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 3, 11, -1, false, '`jumlah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "stock_order") {
    ...
    // Master filter
    public function sqlMasterFilter_stock_order()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_stock_order()
    {
        return "`pid`=@pid@";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`stock_order_detail`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("StockOrderDetailList");
    }
    ...
    {
        global $Language;
        if ($pageName == "StockOrderDetailView") {
            return $Language->phrase("View");
        } elseif ($pageName == "StockOrderDetailEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "StockOrderDetailAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StockOrderDetailView";
            case Config("API_ADD_ACTION"):
                return "StockOrderDetailAdd";
            case Config("API_EDIT_ACTION"):
                return "StockOrderDetailEdit";
            case Config("API_DELETE_ACTION"):
                return "StockOrderDetailDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StockOrderDetailView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StockOrderDetailView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "StockOrderDetailAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "StockOrderDetailAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StockOrderDetailEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StockOrderDetailAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("StockOrderDetailDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "stock_order" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
