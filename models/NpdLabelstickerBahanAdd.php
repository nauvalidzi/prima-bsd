 ...
 * Page class
 */
class NpdLabelstickerBahanAdd extends NpdLabelstickerBahan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdLabelstickerBahanAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("NpdLabelstickerBahanList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "NpdLabelstickerBahanList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "NpdLabelstickerBahanView") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("NpdLabelstickerBahanList"), "", $this->TableVar, true);
