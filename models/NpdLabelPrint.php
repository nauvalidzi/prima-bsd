...
/**
 * Table class for npd_label_print
 */
class NpdLabelPrint extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'npd_label_print';
        $this->TableName = 'npd_label_print';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`npd_label_print`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // value
        $this->value = new DbField('npd_label_print', 'npd_label_print', 'x_value', 'value', '`value`', '`value`', 200, 255, -1, false, '`value`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`npd_label_print`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NpdLabelPrintList");
    }
    ...
    {
        global $Language;
        if ($pageName == "NpdLabelPrintView") {
            return $Language->phrase("View");
        } elseif ($pageName == "NpdLabelPrintEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "NpdLabelPrintAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NpdLabelPrintView";
            case Config("API_ADD_ACTION"):
                return "NpdLabelPrintAdd";
            case Config("API_EDIT_ACTION"):
                return "NpdLabelPrintEdit";
            case Config("API_DELETE_ACTION"):
                return "NpdLabelPrintDelete";
            case Config("API_LIST_ACTION"):
                return "NpdLabelPrintList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NpdLabelPrintView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("NpdLabelPrintView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "NpdLabelPrintAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "NpdLabelPrintAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdLabelPrintEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdLabelPrintAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("NpdLabelPrintDelete", $this->getUrlParm());
    }
