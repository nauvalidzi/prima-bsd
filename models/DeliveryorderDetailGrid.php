 ...
 * Page class
 */
class DeliveryorderDetailGrid extends DeliveryorderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DeliveryorderDetailGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fdeliveryorder_detailgrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "deliveryorder") {
            $this->iddeliveryorder->CurrentValue = $this->iddeliveryorder->getSessionValue();
        }
        $conn = $this->getConnection();
