 ...
 * Page class
 */
class NpdSampleView extends NpdSample
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdSampleView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdSampleList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdSampleList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdSampleList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
