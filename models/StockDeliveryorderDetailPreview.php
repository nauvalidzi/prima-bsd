 ...
 * Page class
 */
class StockDeliveryorderDetailPreview extends StockDeliveryorderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockDeliveryorderDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "stock_deliveryorder") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=stock_deliveryorder&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
