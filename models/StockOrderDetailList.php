 ...
 * Page class
 */
class StockOrderDetailList extends StockOrderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockOrderDetailList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fstock_order_detaillist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "StockOrderDetailDelete";
        $this->MultiUpdateUrl = "StockOrderDetailUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fstock_order_detaillistsrch";
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fstock_order_detaillist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
