...
class CustomerAdd extends Customer
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // budget_bonus_persen
        $this->budget_bonus_persen->setDbValueDef($rsnew, $this->budget_bonus_persen->CurrentValue, null, false);

        // hutang_max
        $this->hutang_max->setDbValueDef($rsnew, $this->hutang_max->CurrentValue, null, false);
