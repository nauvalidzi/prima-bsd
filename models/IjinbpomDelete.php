 ...
 * Page class
 */
class IjinbpomDelete extends Ijinbpom
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinbpomDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IjinbpomList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("IjinbpomList"); // Return to list
            return;
        }
