 ...
 * Page class
 */
class NpdKemasanKomposisiAdd extends NpdKemasanKomposisi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdKemasanKomposisiAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("NpdKemasanKomposisiList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "NpdKemasanKomposisiList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "NpdKemasanKomposisiView") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("NpdKemasanKomposisiList"), "", $this->TableVar, true);
