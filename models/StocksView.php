 ...
 * Page class
 */
class StocksView extends Stocks
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "StocksList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "StocksList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "StocksList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
