 ...
 * Page class
 */
class NpdMasterSpesifikasiEdit extends NpdMasterSpesifikasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdMasterSpesifikasiEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // bentukan
            $this->bentukan->setDbValueDef($rsnew, $this->bentukan->CurrentValue, null, $this->bentukan->ReadOnly);
            ...
            // nour
            $this->nour->setDbValueDef($rsnew, $this->nour->CurrentValue, null, $this->nour->ReadOnly);

            // updated_at
            $this->updated_at->setDbValueDef($rsnew, UnFormatDateTime($this->updated_at->CurrentValue, 0), null, $this->updated_at->ReadOnly);

            // updated_user
            $this->updated_user->setDbValueDef($rsnew, $this->updated_user->CurrentValue, null, $this->updated_user->ReadOnly);
