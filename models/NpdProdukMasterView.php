 ...
 * Page class
 */
class NpdProdukMasterView extends NpdProdukMaster
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdProdukMasterView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdProdukMasterList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdProdukMasterList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdProdukMasterList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
