...
/**
 * Table class for v_do_stock
 */
class VDoStock extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_do_stock';
        $this->TableName = 'v_do_stock';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_do_stock`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idcustomer
        $this->idcustomer = new DbField('v_do_stock', 'v_do_stock', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 20, 20, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jumlah
        $this->jumlah = new DbField('v_do_stock', 'v_do_stock', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 131, 32, -1, false, '`jumlah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_do_stock`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VDoStockList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VDoStockView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VDoStockEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VDoStockAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VDoStockView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VDoStockView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VDoStockAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VDoStockAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VDoStockEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VDoStockAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VDoStockDelete", $this->getUrlParm());
    }
