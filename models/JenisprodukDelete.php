 ...
 * Page class
 */
class JenisprodukDelete extends Jenisproduk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisprodukDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("JenisprodukList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("JenisprodukList"); // Return to list
                return;
            }
        }
