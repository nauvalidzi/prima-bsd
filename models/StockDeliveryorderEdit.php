 ...
 * Page class
 */
class StockDeliveryorderEdit extends StockDeliveryorder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockDeliveryorderEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("StockDeliveryorderList"); // No matching record, return to list
                    return;
                }
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "StockDeliveryorderList") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("stock_deliveryorder_detail", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // receipt_by
            $this->receipt_by->setDbValueDef($rsnew, $this->receipt_by->CurrentValue, 0, $this->receipt_by->ReadOnly);
            ...
            if ($updateRow) {
                ...
                if ($editRow) {
                    $detailPage = Container("StockDeliveryorderDetailGrid");
                    if (in_array("stock_deliveryorder_detail", $detailTblVar) && $detailPage->DetailEdit) {
                        $Security->loadCurrentUserLevel($this->ProjectID . "stock_deliveryorder_detail"); // Load user level of detail table
