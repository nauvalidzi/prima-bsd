 ...
 * Page class
 */
class NpdMasterKemasanView extends NpdMasterKemasan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdMasterKemasanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdMasterKemasanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdMasterKemasanList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdMasterKemasanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
