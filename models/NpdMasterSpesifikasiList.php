 ...
 * Page class
 */
class NpdMasterSpesifikasiList extends NpdMasterSpesifikasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdMasterSpesifikasiList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fnpd_master_spesifikasilist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "NpdMasterSpesifikasiAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "NpdMasterSpesifikasiDelete";
        $this->MultiUpdateUrl = "NpdMasterSpesifikasiUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fnpd_master_spesifikasilistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->grup->AdvancedSearch->toJson(), ","); // Field grup
        ...
        $filterList = Concat($filterList, $this->bentukan->AdvancedSearch->toJson(), ","); // Field bentukan
        ...
        $filterList = Concat($filterList, $this->nour->AdvancedSearch->toJson(), ","); // Field nour
        $filterList = Concat($filterList, $this->updated_at->AdvancedSearch->toJson(), ","); // Field updated_at
        $filterList = Concat($filterList, $this->updated_user->AdvancedSearch->toJson(), ","); // Field updated_user
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fnpd_master_spesifikasilistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field grup
        $this->grup->AdvancedSearch->SearchValue = @$filter["x_grup"];
        $this->grup->AdvancedSearch->SearchOperator = @$filter["z_grup"];
        $this->grup->AdvancedSearch->SearchCondition = @$filter["v_grup"];
        $this->grup->AdvancedSearch->SearchValue2 = @$filter["y_grup"];
        $this->grup->AdvancedSearch->SearchOperator2 = @$filter["w_grup"];
        $this->grup->AdvancedSearch->save();
        ...
        // Field sediaan
        $this->sediaan->AdvancedSearch->SearchValue = @$filter["x_sediaan"];
        $this->sediaan->AdvancedSearch->SearchOperator = @$filter["z_sediaan"];
        $this->sediaan->AdvancedSearch->SearchCondition = @$filter["v_sediaan"];
        $this->sediaan->AdvancedSearch->SearchValue2 = @$filter["y_sediaan"];
        $this->sediaan->AdvancedSearch->SearchOperator2 = @$filter["w_sediaan"];
        $this->sediaan->AdvancedSearch->save();

        // Field bentukan
        $this->bentukan->AdvancedSearch->SearchValue = @$filter["x_bentukan"];
        $this->bentukan->AdvancedSearch->SearchOperator = @$filter["z_bentukan"];
        $this->bentukan->AdvancedSearch->SearchCondition = @$filter["v_bentukan"];
        $this->bentukan->AdvancedSearch->SearchValue2 = @$filter["y_bentukan"];
        $this->bentukan->AdvancedSearch->SearchOperator2 = @$filter["w_bentukan"];
        $this->bentukan->AdvancedSearch->save();
        ...
        // Field nour
        $this->nour->AdvancedSearch->SearchValue = @$filter["x_nour"];
        $this->nour->AdvancedSearch->SearchOperator = @$filter["z_nour"];
        $this->nour->AdvancedSearch->SearchCondition = @$filter["v_nour"];
        $this->nour->AdvancedSearch->SearchValue2 = @$filter["y_nour"];
        $this->nour->AdvancedSearch->SearchOperator2 = @$filter["w_nour"];
        $this->nour->AdvancedSearch->save();
        ...
        // Field updated_user
        $this->updated_user->AdvancedSearch->SearchValue = @$filter["x_updated_user"];
        $this->updated_user->AdvancedSearch->SearchOperator = @$filter["z_updated_user"];
        $this->updated_user->AdvancedSearch->SearchCondition = @$filter["v_updated_user"];
        $this->updated_user->AdvancedSearch->SearchValue2 = @$filter["y_updated_user"];
        $this->updated_user->AdvancedSearch->SearchOperator2 = @$filter["w_updated_user"];
        $this->updated_user->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->nour); // nour
            $this->updateSort($this->updated_at); // updated_at
            $this->updateSort($this->updated_user); // updated_user
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fnpd_master_spesifikasilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fnpd_master_spesifikasilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fnpd_master_spesifikasilist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fnpd_master_spesifikasilistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
