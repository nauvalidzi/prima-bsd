 ...
 * Page class
 */
class IjinhakiStatusView extends IjinhakiStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinhakiStatusView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "IjinhakiStatusList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "IjinhakiStatusList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "IjinhakiStatusList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
