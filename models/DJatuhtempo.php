...
class DJatuhtempo extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // idinvoice
        $this->idinvoice = new DbField('d_jatuhtempo', 'd_jatuhtempo', 'x_idinvoice', 'idinvoice', '`idinvoice`', '`idinvoice`', 20, 20, -1, false, '`idinvoice`', false, false, false, 'FORMATTED TEXT', 'NO');
