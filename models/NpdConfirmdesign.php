...
/**
 * Table class for npd_confirmdesign
 */
class NpdConfirmdesign extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'npd_confirmdesign';
        $this->TableName = 'npd_confirmdesign';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`npd_confirmdesign`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idnpd
        $this->idnpd = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_idnpd', 'idnpd', '`idnpd`', '`idnpd`', 20, 20, -1, false, '`idnpd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->desaindepan->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->desaindepan->Param, "CustomMsg");
        $this->Fields['desaindepan'] = &$this->desaindepan;

        // desainbelakang
        $this->desainbelakang = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_desainbelakang', 'desainbelakang', '`desainbelakang`', '`desainbelakang`', 200, 255, -1, false, '`desainbelakang`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->desainbelakang->Sortable = true; // Allow sort
        $this->desainbelakang->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->desainbelakang->Param, "CustomMsg");
        $this->Fields['desainbelakang'] = &$this->desainbelakang;

        // catatan
        $this->catatan = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_catatan', 'catatan', '`catatan`', '`catatan`', 201, 65535, -1, false, '`catatan`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // tglprimer
        $this->tglprimer = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_tglprimer', 'tglprimer', '`tglprimer`', CastDateFieldForLike("`tglprimer`", 0, "DB"), 133, 10, 0, false, '`tglprimer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tglprimer->Sortable = true; // Allow sort
        $this->tglprimer->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->tglprimer->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->tglprimer->Param, "CustomMsg");
        $this->Fields['tglprimer'] = &$this->tglprimer;

        // desainsekunder
        $this->desainsekunder = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_desainsekunder', 'desainsekunder', '`desainsekunder`', '`desainsekunder`', 200, 255, -1, false, '`desainsekunder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // catatansekunder
        $this->catatansekunder = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_catatansekunder', 'catatansekunder', '`catatansekunder`', '`catatansekunder`', 200, 255, -1, false, '`catatansekunder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->catatansekunder->Sortable = true; // Allow sort
        $this->catatansekunder->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->catatansekunder->Param, "CustomMsg");
        $this->Fields['catatansekunder'] = &$this->catatansekunder;

        // tglsekunder
        $this->tglsekunder = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_tglsekunder', 'tglsekunder', '`tglsekunder`', CastDateFieldForLike("`tglsekunder`", 0, "DB"), 133, 10, 0, false, '`tglsekunder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tglsekunder->Sortable = true; // Allow sort
        $this->tglsekunder->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        // created_at
        $this->created_at = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, false, '`created_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated_at
        $this->updated_at = new DbField('npd_confirmdesign', 'npd_confirmdesign', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, false, '`updated_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`npd_confirmdesign`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->tglprimer->DbValue = $row['tglprimer'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NpdConfirmdesignList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "NpdConfirmdesignEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "NpdConfirmdesignAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NpdConfirmdesignView";
            case Config("API_ADD_ACTION"):
                return "NpdConfirmdesignAdd";
            case Config("API_EDIT_ACTION"):
                return "NpdConfirmdesignEdit";
            case Config("API_DELETE_ACTION"):
                return "NpdConfirmdesignDelete";
            case Config("API_LIST_ACTION"):
                return "NpdConfirmdesignList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NpdConfirmdesignView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("NpdConfirmdesignView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "NpdConfirmdesignAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "NpdConfirmdesignAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdConfirmdesignEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdConfirmdesignAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("NpdConfirmdesignDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->desaindepan->EditValue = $this->desaindepan->CurrentValue;
        ...
        $this->desainbelakang->EditValue = $this->desainbelakang->CurrentValue;
        ...
        $this->tglprimer->EditValue = FormatDateTime($this->tglprimer->CurrentValue, 8);
        ...
        $this->catatansekunder->EditValue = $this->catatansekunder->CurrentValue;
