...
/**
 * Table class for v_invoice_unpaid
 */
class VInvoiceUnpaid extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_invoice_unpaid';
        $this->TableName = 'v_invoice_unpaid';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_invoice_unpaid`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idcustomer
        $this->idcustomer = new DbField('v_invoice_unpaid', 'v_invoice_unpaid', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 3, 11, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // kodecustomer
        $this->kodecustomer = new DbField('v_invoice_unpaid', 'v_invoice_unpaid', 'x_kodecustomer', 'kodecustomer', '`kodecustomer`', '`kodecustomer`', 200, 20, -1, false, '`kodecustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // namacustomer
        $this->namacustomer = new DbField('v_invoice_unpaid', 'v_invoice_unpaid', 'x_namacustomer', 'namacustomer', '`namacustomer`', '`namacustomer`', 200, 100, -1, false, '`namacustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_invoice_unpaid`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VInvoiceUnpaidList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VInvoiceUnpaidView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VInvoiceUnpaidEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VInvoiceUnpaidAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VInvoiceUnpaidView";
            case Config("API_ADD_ACTION"):
                return "VInvoiceUnpaidAdd";
            case Config("API_EDIT_ACTION"):
                return "VInvoiceUnpaidEdit";
            case Config("API_DELETE_ACTION"):
                return "VInvoiceUnpaidDelete";
            case Config("API_LIST_ACTION"):
                return "VInvoiceUnpaidList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VInvoiceUnpaidView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VInvoiceUnpaidView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VInvoiceUnpaidAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VInvoiceUnpaidAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VInvoiceUnpaidEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VInvoiceUnpaidAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VInvoiceUnpaidDelete", $this->getUrlParm());
    }
