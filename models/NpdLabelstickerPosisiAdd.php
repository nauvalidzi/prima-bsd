 ...
 * Page class
 */
class NpdLabelstickerPosisiAdd extends NpdLabelstickerPosisi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdLabelstickerPosisiAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("NpdLabelstickerPosisiList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "NpdLabelstickerPosisiList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "NpdLabelstickerPosisiView") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("NpdLabelstickerPosisiList"), "", $this->TableVar, true);
