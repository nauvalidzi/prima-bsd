 ...
 * Page class
 */
class BotHistoryList extends BotHistory
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'bot_history';

    // Page object name
    public $PageObjName = "BotHistoryList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fbot_historylist";
    ...
    public function __construct()
    {
        ...
        // Table object (bot_history)
        if (!isset($GLOBALS["bot_history"]) || get_class($GLOBALS["bot_history"]) == PROJECT_NAMESPACE . "bot_history") {
            $GLOBALS["bot_history"] = &$this;
        }
        ...
        $this->AddUrl = "BotHistoryAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "BotHistoryDelete";
        $this->MultiUpdateUrl = "BotHistoryUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'bot_history');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fbot_historylistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("bot_history"));
                $doc->Text = @$content;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fbot_historylist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
