...
class NpdHargaList extends NpdHarga
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->viskositasbarang->AdvancedSearch->toJson(), ","); // Field viskositasbarang
        $filterList = Concat($filterList, $this->idaplikasibarang->AdvancedSearch->toJson(), ","); // Field idaplikasibarang
        $filterList = Concat($filterList, $this->ukuranwadah->AdvancedSearch->toJson(), ","); // Field ukuranwadah
        ...
        $filterList = Concat($filterList, $this->packingkarton->AdvancedSearch->toJson(), ","); // Field packingkarton
        ...
        $filterList = Concat($filterList, $this->keteranganetiket->AdvancedSearch->toJson(), ","); // Field keteranganetiket
        ...
        $filterList = Concat($filterList, $this->hargapcs->AdvancedSearch->toJson(), ","); // Field hargapcs
    ...
    protected function restoreFilterList()
    {
        ...
        // Field viskositasbarang
        $this->viskositasbarang->AdvancedSearch->SearchValue = @$filter["x_viskositasbarang"];
        $this->viskositasbarang->AdvancedSearch->SearchOperator = @$filter["z_viskositasbarang"];
        $this->viskositasbarang->AdvancedSearch->SearchCondition = @$filter["v_viskositasbarang"];
        $this->viskositasbarang->AdvancedSearch->SearchValue2 = @$filter["y_viskositasbarang"];
        $this->viskositasbarang->AdvancedSearch->SearchOperator2 = @$filter["w_viskositasbarang"];
        $this->viskositasbarang->AdvancedSearch->save();

        // Field idaplikasibarang
        $this->idaplikasibarang->AdvancedSearch->SearchValue = @$filter["x_idaplikasibarang"];
        $this->idaplikasibarang->AdvancedSearch->SearchOperator = @$filter["z_idaplikasibarang"];
        $this->idaplikasibarang->AdvancedSearch->SearchCondition = @$filter["v_idaplikasibarang"];
        $this->idaplikasibarang->AdvancedSearch->SearchValue2 = @$filter["y_idaplikasibarang"];
        $this->idaplikasibarang->AdvancedSearch->SearchOperator2 = @$filter["w_idaplikasibarang"];
        $this->idaplikasibarang->AdvancedSearch->save();

        // Field ukuranwadah
        $this->ukuranwadah->AdvancedSearch->SearchValue = @$filter["x_ukuranwadah"];
        $this->ukuranwadah->AdvancedSearch->SearchOperator = @$filter["z_ukuranwadah"];
        $this->ukuranwadah->AdvancedSearch->SearchCondition = @$filter["v_ukuranwadah"];
        $this->ukuranwadah->AdvancedSearch->SearchValue2 = @$filter["y_ukuranwadah"];
        $this->ukuranwadah->AdvancedSearch->SearchOperator2 = @$filter["w_ukuranwadah"];
        $this->ukuranwadah->AdvancedSearch->save();
        ...
        // Field packingkarton
        $this->packingkarton->AdvancedSearch->SearchValue = @$filter["x_packingkarton"];
        $this->packingkarton->AdvancedSearch->SearchOperator = @$filter["z_packingkarton"];
        $this->packingkarton->AdvancedSearch->SearchCondition = @$filter["v_packingkarton"];
        $this->packingkarton->AdvancedSearch->SearchValue2 = @$filter["y_packingkarton"];
        $this->packingkarton->AdvancedSearch->SearchOperator2 = @$filter["w_packingkarton"];
        $this->packingkarton->AdvancedSearch->save();
        ...
        // Field keteranganetiket
        $this->keteranganetiket->AdvancedSearch->SearchValue = @$filter["x_keteranganetiket"];
        $this->keteranganetiket->AdvancedSearch->SearchOperator = @$filter["z_keteranganetiket"];
        $this->keteranganetiket->AdvancedSearch->SearchCondition = @$filter["v_keteranganetiket"];
        $this->keteranganetiket->AdvancedSearch->SearchValue2 = @$filter["y_keteranganetiket"];
        $this->keteranganetiket->AdvancedSearch->SearchOperator2 = @$filter["w_keteranganetiket"];
        $this->keteranganetiket->AdvancedSearch->save();
        ...
        // Field hargapcs
        $this->hargapcs->AdvancedSearch->SearchValue = @$filter["x_hargapcs"];
        $this->hargapcs->AdvancedSearch->SearchOperator = @$filter["z_hargapcs"];
        $this->hargapcs->AdvancedSearch->SearchCondition = @$filter["v_hargapcs"];
        $this->hargapcs->AdvancedSearch->SearchValue2 = @$filter["y_hargapcs"];
        $this->hargapcs->AdvancedSearch->SearchOperator2 = @$filter["w_hargapcs"];
        $this->hargapcs->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->viskositasbarang, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->idaplikasibarang, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->ukuranwadah, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->packingkarton, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->keteranganetiket, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->viskositasbarang); // viskositasbarang
            $this->updateSort($this->idaplikasibarang); // idaplikasibarang
            $this->updateSort($this->hargapcs); // hargapcs
            $this->updateSort($this->disetujui); // disetujui
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->bentuk->setSort("");
                $this->viskositasbarang->setSort("");
                $this->idaplikasibarang->setSort("");
                $this->ukuranwadah->setSort("");
