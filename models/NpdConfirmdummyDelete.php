 ...
 * Page class
 */
class NpdConfirmdummyDelete extends NpdConfirmdummy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmdummyDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdConfirmdummyList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NpdConfirmdummyList"); // Return to list
                return;
            }
        }
