...
/**
 * Table class for level_customer
 */
class LevelCustomer extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'level_customer';
        $this->TableName = 'level_customer';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`level_customer`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`level_customer`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LevelCustomerList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "LevelCustomerEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "LevelCustomerAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LevelCustomerView";
            case Config("API_ADD_ACTION"):
                return "LevelCustomerAdd";
            case Config("API_EDIT_ACTION"):
                return "LevelCustomerEdit";
            case Config("API_DELETE_ACTION"):
                return "LevelCustomerDelete";
            case Config("API_LIST_ACTION"):
                return "LevelCustomerList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("LevelCustomerView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("LevelCustomerView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "LevelCustomerAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "LevelCustomerAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LevelCustomerEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LevelCustomerAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("LevelCustomerDelete", $this->getUrlParm());
    }
