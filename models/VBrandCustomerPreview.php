 ...
 * Page class
 */
class VBrandCustomerPreview extends VBrandCustomer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VBrandCustomerPreview";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VBrandCustomerList"), "", $this->TableVar, true);
        $pageId = "preview";
