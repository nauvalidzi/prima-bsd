...
class NpdHargaEdit extends NpdHarga
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // ukuranwadah
            $this->ukuranwadah->setDbValueDef($rsnew, $this->ukuranwadah->CurrentValue, "", $this->ukuranwadah->ReadOnly);
            ...
            // packingkarton
            $this->packingkarton->setDbValueDef($rsnew, $this->packingkarton->CurrentValue, "", $this->packingkarton->ReadOnly);
            ...
            // keteranganetiket
            $this->keteranganetiket->setDbValueDef($rsnew, $this->keteranganetiket->CurrentValue, null, $this->keteranganetiket->ReadOnly);
