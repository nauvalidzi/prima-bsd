...
/**
 * Table class for serahterima
 */
class Serahterima extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'serahterima';
        $this->TableName = 'serahterima';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`serahterima`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('serahterima', 'serahterima', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idpegawai
        $this->idpegawai = new DbField('serahterima', 'serahterima', 'x_idpegawai', 'idpegawai', '`idpegawai`', '`idpegawai`', 3, 11, -1, false, '`idpegawai`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // idcustomer
        $this->idcustomer = new DbField('serahterima', 'serahterima', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 3, 11, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->idcustomer->Lookup = new Lookup('idcustomer', 'customer', false, 'id', ["kode","nama","",""], ["x_idpegawai"], ["npd_sample x_idnpd"], ["idpegawai"], ["x_idpegawai"], [], [], '', '');
                break;
            default:
                $this->idcustomer->Lookup = new Lookup('idcustomer', 'customer', false, 'id', ["kode","nama","",""], ["x_idpegawai"], ["npd_sample x_idnpd"], ["idpegawai"], ["x_idpegawai"], [], [], '', '');
                break;
        ...
        // tanggalrequest
        $this->tanggalrequest = new DbField('serahterima', 'serahterima', 'x_tanggalrequest', 'tanggalrequest', '`tanggalrequest`', CastDateFieldForLike("`tanggalrequest`", 0, "DB"), 135, 19, 0, false, '`tanggalrequest`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tanggalrequest->Nullable = false; // NOT NULL field
        $this->tanggalrequest->Required = true; // Required field
        $this->tanggalrequest->Sortable = true; // Allow sort
        $this->tanggalrequest->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->tanggalrequest->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->tanggalrequest->Param, "CustomMsg");
        $this->Fields['tanggalrequest'] = &$this->tanggalrequest;

        // tanggalst
        $this->tanggalst = new DbField('serahterima', 'serahterima', 'x_tanggalst', 'tanggalst', '`tanggalst`', CastDateFieldForLike("`tanggalst`", 0, "DB"), 135, 19, 0, false, '`tanggalst`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tanggalst->Nullable = false; // NOT NULL field
        $this->tanggalst->Required = true; // Required field
        $this->tanggalst->Sortable = true; // Allow sort
        $this->tanggalst->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->tanggalst->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->tanggalst->Param, "CustomMsg");
        $this->Fields['tanggalst'] = &$this->tanggalst;

        // created_at
        $this->created_at = new DbField('serahterima', 'serahterima', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, false, '`created_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // created_by
        $this->created_by = new DbField('serahterima', 'serahterima', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, 11, -1, false, '`created_by`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // readonly
        $this->readonly = new DbField('serahterima', 'serahterima', 'x_readonly', 'readonly', '`readonly`', '`readonly`', 16, 1, -1, false, '`readonly`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->readonly->Nullable = false; // NOT NULL field
        $this->readonly->Sortable = true; // Allow sort
        $this->readonly->DataType = DATATYPE_BOOLEAN;
        switch ($CurrentLanguage) {
            case "en":
                $this->readonly->Lookup = new Lookup('readonly', 'serahterima', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->readonly->Lookup = new Lookup('readonly', 'serahterima', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`serahterima`";
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id']) && $rsold['id'] != $rs['id'])) { // Update detail field 'idserahterima'
            $cascadeUpdate = true;
            $rscascade['idserahterima'] = $rs['id'];
        }
        if ($cascadeUpdate) {
            $rswrk = Container("npd_sample")->loadRs("`idserahterima` = " . QuotedValue($rsold['id'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("npd_sample")->loadRs("`idserahterima` = " . QuotedValue($rs['id'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->tanggalrequest->DbValue = $row['tanggalrequest'];
        $this->tanggalst->DbValue = $row['tanggalst'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SerahterimaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "SerahterimaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "SerahterimaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SerahterimaView";
            case Config("API_ADD_ACTION"):
                return "SerahterimaAdd";
            case Config("API_EDIT_ACTION"):
                return "SerahterimaEdit";
            case Config("API_DELETE_ACTION"):
                return "SerahterimaDelete";
            case Config("API_LIST_ACTION"):
                return "SerahterimaList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SerahterimaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("SerahterimaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "SerahterimaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "SerahterimaAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SerahterimaEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("SerahterimaEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SerahterimaAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("SerahterimaAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("SerahterimaDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->tanggalrequest->EditValue = FormatDateTime($this->tanggalrequest->CurrentValue, 8);
        ...
        $this->tanggalst->EditValue = FormatDateTime($this->tanggalst->CurrentValue, 8);
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->tanggalrequest);
                    $doc->exportCaption($this->tanggalst);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->idpegawai);
                    $doc->exportCaption($this->idcustomer);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->tanggalrequest);
                        $doc->exportField($this->tanggalst);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->idpegawai);
                        $doc->exportField($this->idcustomer);
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `serahterima`";
