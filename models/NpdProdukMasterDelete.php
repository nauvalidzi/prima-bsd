 ...
 * Page class
 */
class NpdProdukMasterDelete extends NpdProdukMaster
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdProdukMasterDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdProdukMasterList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NpdProdukMasterList"); // Return to list
                return;
            }
        }
