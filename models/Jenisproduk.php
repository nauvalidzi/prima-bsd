...
/**
 * Table class for jenisproduk
 */
class Jenisproduk extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'jenisproduk';
        $this->TableName = 'jenisproduk';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`jenisproduk`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('jenisproduk', 'jenisproduk', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idkategoribarang
        $this->idkategoribarang = new DbField('jenisproduk', 'jenisproduk', 'x_idkategoribarang', 'idkategoribarang', '`idkategoribarang`', '`idkategoribarang`', 3, 11, -1, false, '`idkategoribarang`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->idkategoribarang->Lookup = new Lookup('idkategoribarang', 'kategoriproduk', false, 'id', ["nama","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->idkategoribarang->Lookup = new Lookup('idkategoribarang', 'kategoriproduk', false, 'id', ["nama","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // nama
        $this->nama = new DbField('jenisproduk', 'jenisproduk', 'x_nama', 'nama', '`nama`', '`nama`', 200, 50, -1, false, '`nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jenisproduk`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("JenisprodukList");
    }
    ...
    {
        global $Language;
        if ($pageName == "JenisprodukView") {
            return $Language->phrase("View");
        } elseif ($pageName == "JenisprodukEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "JenisprodukAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JenisprodukView";
            case Config("API_ADD_ACTION"):
                return "JenisprodukAdd";
            case Config("API_EDIT_ACTION"):
                return "JenisprodukEdit";
            case Config("API_DELETE_ACTION"):
                return "JenisprodukDelete";
            case Config("API_LIST_ACTION"):
                return "JenisprodukList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("JenisprodukView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("JenisprodukView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "JenisprodukAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "JenisprodukAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("JenisprodukEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("JenisprodukAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("JenisprodukDelete", $this->getUrlParm());
    }
