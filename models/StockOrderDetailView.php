 ...
 * Page class
 */
class StockOrderDetailView extends StockOrderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockOrderDetailView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "StockOrderDetailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "StockOrderDetailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "StockOrderDetailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
