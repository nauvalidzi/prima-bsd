 ...
 * Page class
 */
class KecamatanDelete extends Kecamatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KecamatanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KecamatanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KecamatanList"); // Return to list
                return;
            }
        }
