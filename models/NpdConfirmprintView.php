 ...
 * Page class
 */
class NpdConfirmprintView extends NpdConfirmprint
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmprintView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdConfirmprintList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdConfirmprintList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdConfirmprintList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
