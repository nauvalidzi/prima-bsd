...
/**
 * Table class for v_bonuscustomer_detail
 */
class VBonuscustomerDetail extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_bonuscustomer_detail';
        $this->TableName = 'v_bonuscustomer_detail';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_bonuscustomer_detail`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idinvoice
        $this->idinvoice = new DbField('v_bonuscustomer_detail', 'v_bonuscustomer_detail', 'x_idinvoice', 'idinvoice', '`idinvoice`', '`idinvoice`', 20, 20, -1, false, '`idinvoice`', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_bonuscustomer_detail`";
    }
    ...
    public function applyUserIDFilters($filter)
    {
        ...
        if ($Security->currentUserID() != "" && !$Security->isAdmin()) { // Non system admin
            if ($this->getCurrentMasterTable() == "v_bonuscustomer" || $this->getCurrentMasterTable() == "") {
                $filter = $this->addDetailUserIDFilter($filter, "v_bonuscustomer"); // Add detail User ID filter
            }
        }
        return $filter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VBonuscustomerDetailList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VBonuscustomerDetailView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VBonuscustomerDetailEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VBonuscustomerDetailAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VBonuscustomerDetailView";
            case Config("API_ADD_ACTION"):
                return "VBonuscustomerDetailAdd";
            case Config("API_EDIT_ACTION"):
                return "VBonuscustomerDetailEdit";
            case Config("API_DELETE_ACTION"):
                return "VBonuscustomerDetailDelete";
            case Config("API_LIST_ACTION"):
                return "VBonuscustomerDetailList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VBonuscustomerDetailView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VBonuscustomerDetailView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VBonuscustomerDetailAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VBonuscustomerDetailAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VBonuscustomerDetailEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VBonuscustomerDetailAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VBonuscustomerDetailDelete", $this->getUrlParm());
    }
