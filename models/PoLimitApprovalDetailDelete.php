 ...
 * Page class
 */
class PoLimitApprovalDetailDelete extends PoLimitApprovalDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoLimitApprovalDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PoLimitApprovalDetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PoLimitApprovalDetailList"); // Return to list
                return;
            }
        }
