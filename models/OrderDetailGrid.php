 ...
 * Page class
 */
class OrderDetailGrid extends OrderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrderDetailGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "forder_detailgrid";
    ...
    public function run()
    {
        ...
        // Load master record
        if ($this->CurrentMode != "add" && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "order") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // bonus
        $this->bonus->setDbValueDef($rsnew, $this->bonus->CurrentValue, 0, false);
