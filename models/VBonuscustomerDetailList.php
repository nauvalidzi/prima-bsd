 ...
 * Page class
 */
class VBonuscustomerDetailList extends VBonuscustomerDetail
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'v_bonuscustomer_detail';

    // Page object name
    public $PageObjName = "VBonuscustomerDetailList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fv_bonuscustomer_detaillist";
    ...
    public function __construct()
    {
        ...
        // Table object (v_bonuscustomer_detail)
        if (!isset($GLOBALS["v_bonuscustomer_detail"]) || get_class($GLOBALS["v_bonuscustomer_detail"]) == PROJECT_NAMESPACE . "v_bonuscustomer_detail") {
            $GLOBALS["v_bonuscustomer_detail"] = &$this;
        }
        ...
        $this->AddUrl = "VBonuscustomerDetailAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "VBonuscustomerDetailDelete";
        $this->MultiUpdateUrl = "VBonuscustomerDetailUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'v_bonuscustomer_detail');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fv_bonuscustomer_detaillistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("v_bonuscustomer_detail"));
                $doc->Text = @$content;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fv_bonuscustomer_detaillist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
