 ...
 * Page class
 */
class NpdConfirmsampleEdit extends NpdConfirmsample
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmsampleEdit";
    ...
    public function run()
    {
        ...
        $this->idnpd->Required = false;
        $this->idnpd_sample->Required = false;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // alasansetuju
            $this->alasansetuju->setDbValueDef($rsnew, $this->alasansetuju->CurrentValue, null, $this->alasansetuju->ReadOnly);
            ...
            // alamatpemesan
            $this->alamatpemesan->setDbValueDef($rsnew, $this->alamatpemesan->CurrentValue, null, $this->alamatpemesan->ReadOnly);

            // personincharge
            $this->personincharge->setDbValueDef($rsnew, $this->personincharge->CurrentValue, null, $this->personincharge->ReadOnly);
