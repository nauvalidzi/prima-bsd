 ...
 * Page class
 */
class SerahterimaDelete extends Serahterima
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SerahterimaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SerahterimaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("SerahterimaList"); // Return to list
            return;
        }
