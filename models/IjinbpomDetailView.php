 ...
 * Page class
 */
class IjinbpomDetailView extends IjinbpomDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinbpomDetailView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "IjinbpomDetailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "IjinbpomDetailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "IjinbpomDetailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
