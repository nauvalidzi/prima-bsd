 ...
 * Page class
 */
class SuratjalanDelete extends Suratjalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SuratjalanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SuratjalanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("SuratjalanList"); // Return to list
            return;
        }
