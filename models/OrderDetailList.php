 ...
 * Page class
 */
class OrderDetailList extends OrderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrderDetailList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "forder_detaillist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "OrderDetailDelete";
        $this->MultiUpdateUrl = "OrderDetailUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option forder_detaillistsrch";
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.forder_detaillist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
