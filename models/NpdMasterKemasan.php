...
/**
 * Table class for npd_master_kemasan
 */
class NpdMasterKemasan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'npd_master_kemasan';
        $this->TableName = 'npd_master_kemasan';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`npd_master_kemasan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('npd_master_kemasan', 'npd_master_kemasan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // grup
        $this->grup = new DbField('npd_master_kemasan', 'npd_master_kemasan', 'x_grup', 'grup', '`grup`', '`grup`', 200, 50, -1, false, '`grup`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jenis
        $this->jenis = new DbField('npd_master_kemasan', 'npd_master_kemasan', 'x_jenis', 'jenis', '`jenis`', '`jenis`', 200, 50, -1, false, '`jenis`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // subjenis
        $this->subjenis = new DbField('npd_master_kemasan', 'npd_master_kemasan', 'x_subjenis', 'subjenis', '`subjenis`', '`subjenis`', 200, 50, -1, false, '`subjenis`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama
        $this->nama = new DbField('npd_master_kemasan', 'npd_master_kemasan', 'x_nama', 'nama', '`nama`', '`nama`', 200, 50, -1, false, '`nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->nama->Sortable = true; // Allow sort
        $this->nama->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->nama->Param, "CustomMsg");
        $this->Fields['nama'] = &$this->nama;

        // nour
        $this->nour = new DbField('npd_master_kemasan', 'npd_master_kemasan', 'x_nour', 'nour', '`nour`', '`nour`', 3, 11, -1, false, '`nour`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated_user
        $this->updated_user = new DbField('npd_master_kemasan', 'npd_master_kemasan', 'x_updated_user', 'updated_user', '`updated_user`', '`updated_user`', 19, 10, -1, false, '`updated_user`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated_at
        $this->updated_at = new DbField('npd_master_kemasan', 'npd_master_kemasan', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, false, '`updated_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`npd_master_kemasan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NpdMasterKemasanList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "NpdMasterKemasanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "NpdMasterKemasanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NpdMasterKemasanView";
            case Config("API_ADD_ACTION"):
                return "NpdMasterKemasanAdd";
            case Config("API_EDIT_ACTION"):
                return "NpdMasterKemasanEdit";
            case Config("API_DELETE_ACTION"):
                return "NpdMasterKemasanDelete";
            case Config("API_LIST_ACTION"):
                return "NpdMasterKemasanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NpdMasterKemasanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("NpdMasterKemasanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "NpdMasterKemasanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "NpdMasterKemasanAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdMasterKemasanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdMasterKemasanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("NpdMasterKemasanDelete", $this->getUrlParm());
    }
