 ...
 * Page class
 */
class VOrderdetailView extends VOrderdetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VOrderdetailView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "VOrderdetailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VOrderdetailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VOrderdetailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VOrderdetailList"), "", $this->TableVar, true);
        $pageId = "view";
