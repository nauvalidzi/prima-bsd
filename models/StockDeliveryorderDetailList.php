 ...
 * Page class
 */
class StockDeliveryorderDetailList extends StockDeliveryorderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockDeliveryorderDetailList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fstock_deliveryorder_detaillist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "StockDeliveryorderDetailDelete";
        $this->MultiUpdateUrl = "StockDeliveryorderDetailUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fstock_deliveryorder_detaillistsrch";
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fstock_deliveryorder_detaillist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
