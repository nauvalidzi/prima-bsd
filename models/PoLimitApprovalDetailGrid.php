 ...
 * Page class
 */
class PoLimitApprovalDetailGrid extends PoLimitApprovalDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoLimitApprovalDetailGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpo_limit_approval_detailgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_kredit_terpakai") && $CurrentForm->hasValue("o_kredit_terpakai") && $this->kredit_terpakai->CurrentValue != $this->kredit_terpakai->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->kredit_terpakai->clearErrorMessage();
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->idapproval->CurrentValue = null;
        $this->idapproval->OldValue = $this->idapproval->CurrentValue;
        $this->idorder->CurrentValue = null;
        $this->idorder->OldValue = $this->idorder->CurrentValue;
        $this->kredit_terpakai->CurrentValue = null;
        $this->kredit_terpakai->OldValue = $this->kredit_terpakai->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_kredit_terpakai")) {
            $this->kredit_terpakai->setOldValue($CurrentForm->getValue("o_kredit_terpakai"));
        }
    ...
    protected function newRow()
    {
        ...
        $row['idapproval'] = $this->idapproval->CurrentValue;
        $row['idorder'] = $this->idorder->CurrentValue;
        $row['kredit_terpakai'] = $this->kredit_terpakai->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "po_limit_approval") {
            $this->idapproval->CurrentValue = $this->idapproval->getSessionValue();
        }
        $conn = $this->getConnection();
        ...
        // idorder
        $this->idorder->setDbValueDef($rsnew, $this->idorder->CurrentValue, null, false);

        // kredit_terpakai
        $this->kredit_terpakai->setDbValueDef($rsnew, $this->kredit_terpakai->CurrentValue, null, false);
        ...
        if ($this->idapproval->getSessionValue() != "") {
            $rsnew['idapproval'] = $this->idapproval->getSessionValue();
        }
