...
/**
 * Table class for v_invoice_not_sent
 */
class VInvoiceNotSent extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_invoice_not_sent';
        $this->TableName = 'v_invoice_not_sent';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_invoice_not_sent`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idcustomer
        $this->idcustomer = new DbField('v_invoice_not_sent', 'v_invoice_not_sent', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 3, 11, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // kodecustomer
        $this->kodecustomer = new DbField('v_invoice_not_sent', 'v_invoice_not_sent', 'x_kodecustomer', 'kodecustomer', '`kodecustomer`', '`kodecustomer`', 200, 20, -1, false, '`kodecustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // namacustomer
        $this->namacustomer = new DbField('v_invoice_not_sent', 'v_invoice_not_sent', 'x_namacustomer', 'namacustomer', '`namacustomer`', '`namacustomer`', 200, 100, -1, false, '`namacustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_invoice_not_sent`";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->idcustomer->CurrentValue = $keys[0];
            } else {
                $this->idcustomer->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VInvoiceNotSentList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VInvoiceNotSentView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VInvoiceNotSentEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VInvoiceNotSentAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VInvoiceNotSentView";
            case Config("API_ADD_ACTION"):
                return "VInvoiceNotSentAdd";
            case Config("API_EDIT_ACTION"):
                return "VInvoiceNotSentEdit";
            case Config("API_DELETE_ACTION"):
                return "VInvoiceNotSentDelete";
            case Config("API_LIST_ACTION"):
                return "VInvoiceNotSentList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VInvoiceNotSentView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VInvoiceNotSentView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VInvoiceNotSentAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VInvoiceNotSentAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VInvoiceNotSentEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VInvoiceNotSentAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VInvoiceNotSentDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->idcustomer->CurrentValue = $key;
            } else {
                $this->idcustomer->OldValue = $key;
            }
