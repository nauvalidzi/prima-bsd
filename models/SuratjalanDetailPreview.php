 ...
 * Page class
 */
class SuratjalanDetailPreview extends SuratjalanDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SuratjalanDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "suratjalan") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=suratjalan&" . GetForeignKeyUrl("fk_id", $this->idsuratjalan->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "suratjalan") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->idsuratjalan->setQueryStringValue($val);
            }
        }
    }
