...
class NpdSample extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('npd_sample', 'npd_sample', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idnpd
        $this->idnpd = new DbField('npd_sample', 'npd_sample', 'x_idnpd', 'idnpd', '`idnpd`', '`idnpd`', 3, 11, -1, false, '`idnpd`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->idnpd->Lookup = new Lookup('idnpd', 'npd', false, 'id', ["kodeorder","","",""], ["serahterima x_idcustomer"], [], ["idcustomer"], ["x_idcustomer"], ["nama","warna","parfum"], ["x_nama","x_warna","x_bau"], '', '');
                break;
            default:
                $this->idnpd->Lookup = new Lookup('idnpd', 'npd', false, 'id', ["kodeorder","","",""], ["serahterima x_idcustomer"], [], ["idcustomer"], ["x_idcustomer"], ["nama","warna","parfum"], ["x_nama","x_warna","x_bau"], '', '');
                break;
        ...
        // idserahterima
        $this->idserahterima = new DbField('npd_sample', 'npd_sample', 'x_idserahterima', 'idserahterima', '`idserahterima`', '`idserahterima`', 3, 11, -1, false, '`idserahterima`', false, false, false, 'FORMATTED TEXT', 'TEXT');
