 ...
 * Page class
 */
class AlamatCustomerDelete extends AlamatCustomer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlamatCustomerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AlamatCustomerList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AlamatCustomerList"); // Return to list
                return;
            }
        }
