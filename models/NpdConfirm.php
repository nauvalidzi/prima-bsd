...
class NpdConfirm extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('npd_confirm', 'npd_confirm', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idnpd
        $this->idnpd = new DbField('npd_confirm', 'npd_confirm', 'x_idnpd', 'idnpd', '`idnpd`', '`idnpd`', 3, 11, -1, false, '`idnpd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idnpd_sample
        $this->idnpd_sample = new DbField('npd_confirm', 'npd_confirm', 'x_idnpd_sample', 'idnpd_sample', '`idnpd_sample`', '`idnpd_sample`', 3, 11, -1, false, '`idnpd_sample`', false, false, false, 'FORMATTED TEXT', 'SELECT');
