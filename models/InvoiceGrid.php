 ...
 * Page class
 */
class InvoiceGrid extends Invoice
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvoiceGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "finvoicegrid";
    ...
    public function run()
    {
        ...
        // Load master record
        if ($this->CurrentMode != "add" && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "suratjalan_detail") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->totalnonpajak->OldValue = $this->totalnonpajak->CurrentValue;
        ...
        $this->sent->OldValue = $this->sent->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_idorder")) {
    ...
    public function listOptionsLoad()
    {
        ...
        $opt->Header = "Print";
        $opt = &$this->ListOptions->Add("suratjalan");
        $opt->Header = "Surat Jalan";
    }
    ...
    public function listOptionsRendered()
    {
        ...
        $this->idcustomer->Visible = false;
        $this->ListOptions["print"]->Body = "<a href=\"PrintInvoice?id={$this->id->CurrentValue}\" target=\"_blank\">Print Invoice</a>";
        if ($this->sent->CurrentValue == 1) {
        	$this->ListOptions["suratjalan"]->Body = 'Sent';
        } else {
