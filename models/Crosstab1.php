...
class Crosstab1 extends CrosstabTable
{
    ...
    public function __construct()
    {
        ...
        // namapegawai
        $this->namapegawai = new ReportField('Crosstab1', 'Crosstab1', 'x_namapegawai', 'namapegawai', '`namapegawai`', '`namapegawai`', 200, 123, -1, false, '`namapegawai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idcustomer
        $this->idcustomer = new ReportField('Crosstab1', 'Crosstab1', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 21, 20, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idinvoice
        $this->idinvoice = new ReportField('Crosstab1', 'Crosstab1', 'x_idinvoice', 'idinvoice', '`idinvoice`', '`idinvoice`', 20, 20, -1, false, '`idinvoice`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // sisabayar
        $this->sisabayar = new ReportField('Crosstab1', 'Crosstab1', 'x_sisabayar', 'sisabayar', '`sisabayar`', '`sisabayar`', 21, 20, -1, false, '`sisabayar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jatuhtempo
        $this->jatuhtempo = new ReportField('Crosstab1', 'Crosstab1', 'x_jatuhtempo', 'jatuhtempo', '`jatuhtempo`', CastDateFieldForLike("`jatuhtempo`", 0, "DB"), 135, 19, 0, false, '`jatuhtempo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sisahari
        $this->sisahari = new ReportField('Crosstab1', 'Crosstab1', 'x_sisahari', 'sisahari', '`sisahari`', '`sisahari`', 20, 7, -1, false, '`sisahari`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kodeinvoice
        $this->kodeinvoice = new ReportField('Crosstab1', 'Crosstab1', 'x_kodeinvoice', 'kodeinvoice', '`kodeinvoice`', '`kodeinvoice`', 200, 50, -1, false, '`kodeinvoice`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->columnField != "") ? $this->columnField : "`namapegawai`";
    }
    ...
    {
        return $this->sqlDistinctSelect ?? $this->getQueryBuilder()->select("`namapegawai`")->distinct();
    }
    ...
    {
        return ($this->sqlDistinctOrderBy != "") ? $this->sqlDistinctOrderBy : "`namapegawai` ASC";
    }
...
*/
        ...
        $groupCount = 1;
        $this->SummaryFields[0] = new SummaryField('x_sisabayar', 'sisabayar', '`sisabayar`', 'SUM');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("`idpegawai`");
    }
    ...
    {
        return ($this->SqlGroupBy != "") ? $this->SqlGroupBy : "`idpegawai`";
    }
