...
/**
 * Table class for npd_masterdata
 */
class NpdMasterdata extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'npd_masterdata';
        $this->TableName = 'npd_masterdata';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`npd_masterdata`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('npd_masterdata', 'npd_masterdata', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // parent
        $this->parent = new DbField('npd_masterdata', 'npd_masterdata', 'x_parent', 'parent', '`parent`', '`parent`', 200, 50, -1, false, '`parent`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // value
        $this->value = new DbField('npd_masterdata', 'npd_masterdata', 'x_value', 'value', '`value`', '`value`', 200, 255, -1, false, '`value`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`npd_masterdata`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NpdMasterdataList");
    }
    ...
    {
        global $Language;
        if ($pageName == "NpdMasterdataView") {
            return $Language->phrase("View");
        } elseif ($pageName == "NpdMasterdataEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "NpdMasterdataAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NpdMasterdataView";
            case Config("API_ADD_ACTION"):
                return "NpdMasterdataAdd";
            case Config("API_EDIT_ACTION"):
                return "NpdMasterdataEdit";
            case Config("API_DELETE_ACTION"):
                return "NpdMasterdataDelete";
            case Config("API_LIST_ACTION"):
                return "NpdMasterdataList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NpdMasterdataView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("NpdMasterdataView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "NpdMasterdataAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "NpdMasterdataAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdMasterdataEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdMasterdataAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("NpdMasterdataDelete", $this->getUrlParm());
    }
