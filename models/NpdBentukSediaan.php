...
/**
 * Table class for npd_bentuk_sediaan
 */
class NpdBentukSediaan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'npd_bentuk_sediaan';
        $this->TableName = 'npd_bentuk_sediaan';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`npd_bentuk_sediaan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('npd_bentuk_sediaan', 'npd_bentuk_sediaan', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // value
        $this->value = new DbField('npd_bentuk_sediaan', 'npd_bentuk_sediaan', 'x_value', 'value', '`value`', '`value`', 200, 255, -1, false, '`value`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`npd_bentuk_sediaan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NpdBentukSediaanList");
    }
    ...
    {
        global $Language;
        if ($pageName == "NpdBentukSediaanView") {
            return $Language->phrase("View");
        } elseif ($pageName == "NpdBentukSediaanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "NpdBentukSediaanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NpdBentukSediaanView";
            case Config("API_ADD_ACTION"):
                return "NpdBentukSediaanAdd";
            case Config("API_EDIT_ACTION"):
                return "NpdBentukSediaanEdit";
            case Config("API_DELETE_ACTION"):
                return "NpdBentukSediaanDelete";
            case Config("API_LIST_ACTION"):
                return "NpdBentukSediaanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NpdBentukSediaanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("NpdBentukSediaanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "NpdBentukSediaanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "NpdBentukSediaanAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdBentukSediaanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NpdBentukSediaanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("NpdBentukSediaanDelete", $this->getUrlParm());
    }
