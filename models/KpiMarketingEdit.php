 ...
 * Page class
 */
class KpiMarketingEdit extends KpiMarketing
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KpiMarketingEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // bulan
            $this->bulan->setDbValueDef($rsnew, UnFormatDateTime($this->bulan->CurrentValue, 7), null, $this->bulan->ReadOnly);
