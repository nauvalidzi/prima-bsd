 ...
 * Page class
 */
class OrderPengembanganAdd extends OrderPengembangan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrderPengembanganAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "OrderPengembanganView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->cpo_jenis->CurrentValue = null;
        $this->cpo_jenis->OldValue = $this->cpo_jenis->CurrentValue;
        $this->ordernum->CurrentValue = null;
        $this->ordernum->OldValue = $this->ordernum->CurrentValue;
        $this->order_kode->CurrentValue = null;
        $this->order_kode->OldValue = $this->order_kode->CurrentValue;
        $this->orderterimatgl->CurrentValue = null;
        $this->orderterimatgl->OldValue = $this->orderterimatgl->CurrentValue;
        $this->produk_fungsi->CurrentValue = null;
        $this->produk_fungsi->OldValue = $this->produk_fungsi->CurrentValue;
        $this->produk_kualitas->CurrentValue = null;
        $this->produk_kualitas->OldValue = $this->produk_kualitas->CurrentValue;
        $this->produk_campaign->CurrentValue = null;
        $this->produk_campaign->OldValue = $this->produk_campaign->CurrentValue;
        $this->kemasan_satuan->CurrentValue = null;
        $this->kemasan_satuan->OldValue = $this->kemasan_satuan->CurrentValue;
        $this->ordertgl->CurrentValue = null;
        $this->ordertgl->OldValue = $this->ordertgl->CurrentValue;
        $this->custcode->CurrentValue = null;
        $this->custcode->OldValue = $this->custcode->CurrentValue;
        $this->perushnama->CurrentValue = null;
        $this->perushnama->OldValue = $this->perushnama->CurrentValue;
        $this->perushalamat->CurrentValue = null;
        $this->perushalamat->OldValue = $this->perushalamat->CurrentValue;
        $this->perushcp->CurrentValue = null;
        $this->perushcp->OldValue = $this->perushcp->CurrentValue;
        $this->perushjabatan->CurrentValue = null;
        $this->perushjabatan->OldValue = $this->perushjabatan->CurrentValue;
        $this->perushphone->CurrentValue = null;
        $this->perushphone->OldValue = $this->perushphone->CurrentValue;
        $this->perushmobile->CurrentValue = null;
        $this->perushmobile->OldValue = $this->perushmobile->CurrentValue;
        $this->bencmark->CurrentValue = null;
        $this->bencmark->OldValue = $this->bencmark->CurrentValue;
        ...
        $this->bentuksediaan->CurrentValue = null;
        $this->bentuksediaan->OldValue = $this->bentuksediaan->CurrentValue;
        $this->sediaan_ukuran->CurrentValue = null;
        $this->sediaan_ukuran->OldValue = $this->sediaan_ukuran->CurrentValue;
        $this->sediaan_ukuran_satuan->CurrentValue = null;
        $this->sediaan_ukuran_satuan->OldValue = $this->sediaan_ukuran_satuan->CurrentValue;
        $this->produk_viskositas->CurrentValue = null;
        $this->produk_viskositas->OldValue = $this->produk_viskositas->CurrentValue;
        $this->konsepproduk->CurrentValue = null;
        $this->konsepproduk->OldValue = $this->konsepproduk->CurrentValue;
        $this->fragrance->CurrentValue = null;
        $this->fragrance->OldValue = $this->fragrance->CurrentValue;
        ...
        $this->produk_warna_jenis->CurrentValue = null;
        $this->produk_warna_jenis->OldValue = $this->produk_warna_jenis->CurrentValue;
        $this->aksesoris->CurrentValue = null;
        $this->aksesoris->OldValue = $this->aksesoris->CurrentValue;
        $this->produk_lainlain->CurrentValue = null;
        $this->produk_lainlain->OldValue = $this->produk_lainlain->CurrentValue;
        $this->statusproduk->CurrentValue = null;
        $this->statusproduk->OldValue = $this->statusproduk->CurrentValue;
        ...
        $this->rencanakemasan->CurrentValue = null;
        $this->rencanakemasan->OldValue = $this->rencanakemasan->CurrentValue;
        $this->keterangan->CurrentValue = null;
        $this->keterangan->OldValue = $this->keterangan->CurrentValue;
        $this->ekspetasiharga->CurrentValue = null;
        $this->ekspetasiharga->OldValue = $this->ekspetasiharga->CurrentValue;
        $this->kemasan->CurrentValue = null;
        $this->kemasan->OldValue = $this->kemasan->CurrentValue;
        ...
        $this->catatanpackaging->CurrentValue = null;
        $this->catatanpackaging->OldValue = $this->catatanpackaging->CurrentValue;
        $this->infopackaging->CurrentValue = null;
        $this->infopackaging->OldValue = $this->infopackaging->CurrentValue;
        $this->ukuran->CurrentValue = null;
        $this->ukuran->OldValue = $this->ukuran->CurrentValue;
        $this->desainprodukkemasan->CurrentValue = null;
        $this->desainprodukkemasan->OldValue = $this->desainprodukkemasan->CurrentValue;
        $this->desaindiinginkan->CurrentValue = null;
        $this->desaindiinginkan->OldValue = $this->desaindiinginkan->CurrentValue;
        $this->mereknotifikasi->CurrentValue = null;
        $this->mereknotifikasi->OldValue = $this->mereknotifikasi->CurrentValue;
        $this->kategoristatus->CurrentValue = null;
        $this->kategoristatus->OldValue = $this->kategoristatus->CurrentValue;
        $this->kemasan_ukuran_satuan->CurrentValue = null;
        $this->kemasan_ukuran_satuan->OldValue = $this->kemasan_ukuran_satuan->CurrentValue;
        $this->notifikasicatatan->CurrentValue = null;
        $this->notifikasicatatan->OldValue = $this->notifikasicatatan->CurrentValue;
        $this->label_ukuran->CurrentValue = null;
        $this->label_ukuran->OldValue = $this->label_ukuran->CurrentValue;
        $this->infolabel->CurrentValue = null;
        $this->infolabel->OldValue = $this->infolabel->CurrentValue;
        ...
        $this->createat->CurrentValue = null;
        $this->createat->OldValue = $this->createat->CurrentValue;
        $this->createby->CurrentValue = null;
        $this->createby->OldValue = $this->createby->CurrentValue;
        $this->statusdokumen->CurrentValue = null;
        $this->statusdokumen->OldValue = $this->statusdokumen->CurrentValue;
        $this->update_at->CurrentValue = null;
        $this->update_at->OldValue = $this->update_at->CurrentValue;
        $this->status_data->CurrentValue = null;
        $this->status_data->OldValue = $this->status_data->CurrentValue;
        $this->harga_rnd->CurrentValue = null;
        $this->harga_rnd->OldValue = $this->harga_rnd->CurrentValue;
        $this->aplikasi_sediaan->CurrentValue = null;
        $this->aplikasi_sediaan->OldValue = $this->aplikasi_sediaan->CurrentValue;
        $this->hu_hrg_isi->CurrentValue = null;
        $this->hu_hrg_isi->OldValue = $this->hu_hrg_isi->CurrentValue;
        $this->hu_hrg_isi_pro->CurrentValue = null;
        $this->hu_hrg_isi_pro->OldValue = $this->hu_hrg_isi_pro->CurrentValue;
        $this->hu_hrg_kms_primer->CurrentValue = null;
        $this->hu_hrg_kms_primer->OldValue = $this->hu_hrg_kms_primer->CurrentValue;
        $this->hu_hrg_kms_primer_pro->CurrentValue = null;
        $this->hu_hrg_kms_primer_pro->OldValue = $this->hu_hrg_kms_primer_pro->CurrentValue;
        $this->hu_hrg_kms_sekunder->CurrentValue = null;
        $this->hu_hrg_kms_sekunder->OldValue = $this->hu_hrg_kms_sekunder->CurrentValue;
        $this->hu_hrg_kms_sekunder_pro->CurrentValue = null;
        $this->hu_hrg_kms_sekunder_pro->OldValue = $this->hu_hrg_kms_sekunder_pro->CurrentValue;
        $this->hu_hrg_label->CurrentValue = null;
        $this->hu_hrg_label->OldValue = $this->hu_hrg_label->CurrentValue;
        $this->hu_hrg_label_pro->CurrentValue = null;
        $this->hu_hrg_label_pro->OldValue = $this->hu_hrg_label_pro->CurrentValue;
        $this->hu_hrg_total->CurrentValue = null;
        $this->hu_hrg_total->OldValue = $this->hu_hrg_total->CurrentValue;
        $this->hu_hrg_total_pro->CurrentValue = null;
        $this->hu_hrg_total_pro->OldValue = $this->hu_hrg_total_pro->CurrentValue;
        $this->hl_hrg_isi->CurrentValue = null;
        $this->hl_hrg_isi->OldValue = $this->hl_hrg_isi->CurrentValue;
        $this->hl_hrg_isi_pro->CurrentValue = null;
        $this->hl_hrg_isi_pro->OldValue = $this->hl_hrg_isi_pro->CurrentValue;
        $this->hl_hrg_kms_primer->CurrentValue = null;
        $this->hl_hrg_kms_primer->OldValue = $this->hl_hrg_kms_primer->CurrentValue;
        $this->hl_hrg_kms_primer_pro->CurrentValue = null;
        $this->hl_hrg_kms_primer_pro->OldValue = $this->hl_hrg_kms_primer_pro->CurrentValue;
        $this->hl_hrg_kms_sekunder->CurrentValue = null;
        $this->hl_hrg_kms_sekunder->OldValue = $this->hl_hrg_kms_sekunder->CurrentValue;
        $this->hl_hrg_kms_sekunder_pro->CurrentValue = null;
        $this->hl_hrg_kms_sekunder_pro->OldValue = $this->hl_hrg_kms_sekunder_pro->CurrentValue;
        $this->hl_hrg_label->CurrentValue = null;
        $this->hl_hrg_label->OldValue = $this->hl_hrg_label->CurrentValue;
        $this->hl_hrg_label_pro->CurrentValue = null;
        $this->hl_hrg_label_pro->OldValue = $this->hl_hrg_label_pro->CurrentValue;
        $this->hl_hrg_total->CurrentValue = null;
        $this->hl_hrg_total->OldValue = $this->hl_hrg_total->CurrentValue;
        $this->hl_hrg_total_pro->CurrentValue = null;
        $this->hl_hrg_total_pro->OldValue = $this->hl_hrg_total_pro->CurrentValue;
        $this->bs_bahan_aktif_tick->CurrentValue = null;
        $this->bs_bahan_aktif_tick->OldValue = $this->bs_bahan_aktif_tick->CurrentValue;
        $this->bs_bahan_aktif->CurrentValue = null;
        $this->bs_bahan_aktif->OldValue = $this->bs_bahan_aktif->CurrentValue;
        $this->bs_bahan_lain->CurrentValue = null;
        $this->bs_bahan_lain->OldValue = $this->bs_bahan_lain->CurrentValue;
        $this->bs_parfum->CurrentValue = null;
        $this->bs_parfum->OldValue = $this->bs_parfum->CurrentValue;
        $this->bs_estetika->CurrentValue = null;
        $this->bs_estetika->OldValue = $this->bs_estetika->CurrentValue;
        $this->bs_kms_wadah->CurrentValue = null;
        $this->bs_kms_wadah->OldValue = $this->bs_kms_wadah->CurrentValue;
        $this->bs_kms_tutup->CurrentValue = null;
        $this->bs_kms_tutup->OldValue = $this->bs_kms_tutup->CurrentValue;
        $this->bs_kms_sekunder->CurrentValue = null;
        $this->bs_kms_sekunder->OldValue = $this->bs_kms_sekunder->CurrentValue;
        $this->bs_label_desain->CurrentValue = null;
        $this->bs_label_desain->OldValue = $this->bs_label_desain->CurrentValue;
        $this->bs_label_cetak->CurrentValue = null;
        $this->bs_label_cetak->OldValue = $this->bs_label_cetak->CurrentValue;
        $this->bs_label_lain->CurrentValue = null;
        $this->bs_label_lain->OldValue = $this->bs_label_lain->CurrentValue;
        $this->dlv_pickup->CurrentValue = null;
        $this->dlv_pickup->OldValue = $this->dlv_pickup->CurrentValue;
        $this->dlv_singlepoint->CurrentValue = null;
        $this->dlv_singlepoint->OldValue = $this->dlv_singlepoint->CurrentValue;
        $this->dlv_multipoint->CurrentValue = null;
        $this->dlv_multipoint->OldValue = $this->dlv_multipoint->CurrentValue;
        $this->dlv_multipoint_jml->CurrentValue = null;
        $this->dlv_multipoint_jml->OldValue = $this->dlv_multipoint_jml->CurrentValue;
        $this->dlv_term_lain->CurrentValue = null;
        $this->dlv_term_lain->OldValue = $this->dlv_term_lain->CurrentValue;
        $this->catatan_khusus->CurrentValue = null;
        $this->catatan_khusus->OldValue = $this->catatan_khusus->CurrentValue;
        $this->aju_tgl->CurrentValue = null;
        $this->aju_tgl->OldValue = $this->aju_tgl->CurrentValue;
        $this->aju_oleh->CurrentValue = null;
        $this->aju_oleh->OldValue = $this->aju_oleh->CurrentValue;
        $this->proses_tgl->CurrentValue = null;
        $this->proses_tgl->OldValue = $this->proses_tgl->CurrentValue;
        $this->proses_oleh->CurrentValue = null;
        $this->proses_oleh->OldValue = $this->proses_oleh->CurrentValue;
        $this->revisi_tgl->CurrentValue = null;
        $this->revisi_tgl->OldValue = $this->revisi_tgl->CurrentValue;
        $this->revisi_oleh->CurrentValue = null;
        $this->revisi_oleh->OldValue = $this->revisi_oleh->CurrentValue;
        $this->revisi_akun_tgl->CurrentValue = null;
        $this->revisi_akun_tgl->OldValue = $this->revisi_akun_tgl->CurrentValue;
        $this->revisi_akun_oleh->CurrentValue = null;
        $this->revisi_akun_oleh->OldValue = $this->revisi_akun_oleh->CurrentValue;
        $this->revisi_rnd_tgl->CurrentValue = null;
        $this->revisi_rnd_tgl->OldValue = $this->revisi_rnd_tgl->CurrentValue;
        $this->revisi_rnd_oleh->CurrentValue = null;
        $this->revisi_rnd_oleh->OldValue = $this->revisi_rnd_oleh->CurrentValue;
        $this->rnd_tgl->CurrentValue = null;
        $this->rnd_tgl->OldValue = $this->rnd_tgl->CurrentValue;
        $this->rnd_oleh->CurrentValue = null;
        $this->rnd_oleh->OldValue = $this->rnd_oleh->CurrentValue;
        $this->ap_tgl->CurrentValue = null;
        $this->ap_tgl->OldValue = $this->ap_tgl->CurrentValue;
        $this->ap_oleh->CurrentValue = null;
        $this->ap_oleh->OldValue = $this->ap_oleh->CurrentValue;
        $this->batal_tgl->CurrentValue = null;
        $this->batal_tgl->OldValue = $this->batal_tgl->CurrentValue;
        $this->batal_oleh->CurrentValue = null;
        $this->batal_oleh->OldValue = $this->batal_oleh->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['cpo_jenis'] = $this->cpo_jenis->CurrentValue;
        $row['ordernum'] = $this->ordernum->CurrentValue;
        $row['order_kode'] = $this->order_kode->CurrentValue;
        $row['orderterimatgl'] = $this->orderterimatgl->CurrentValue;
        $row['produk_fungsi'] = $this->produk_fungsi->CurrentValue;
        $row['produk_kualitas'] = $this->produk_kualitas->CurrentValue;
        $row['produk_campaign'] = $this->produk_campaign->CurrentValue;
        $row['kemasan_satuan'] = $this->kemasan_satuan->CurrentValue;
        $row['ordertgl'] = $this->ordertgl->CurrentValue;
        $row['custcode'] = $this->custcode->CurrentValue;
        $row['perushnama'] = $this->perushnama->CurrentValue;
        $row['perushalamat'] = $this->perushalamat->CurrentValue;
        $row['perushcp'] = $this->perushcp->CurrentValue;
        $row['perushjabatan'] = $this->perushjabatan->CurrentValue;
        $row['perushphone'] = $this->perushphone->CurrentValue;
        $row['perushmobile'] = $this->perushmobile->CurrentValue;
        $row['bencmark'] = $this->bencmark->CurrentValue;
        $row['kategoriproduk'] = $this->kategoriproduk->CurrentValue;
        $row['jenisproduk'] = $this->jenisproduk->CurrentValue;
        $row['bentuksediaan'] = $this->bentuksediaan->CurrentValue;
        $row['sediaan_ukuran'] = $this->sediaan_ukuran->CurrentValue;
        $row['sediaan_ukuran_satuan'] = $this->sediaan_ukuran_satuan->CurrentValue;
        $row['produk_viskositas'] = $this->produk_viskositas->CurrentValue;
        $row['konsepproduk'] = $this->konsepproduk->CurrentValue;
        $row['fragrance'] = $this->fragrance->CurrentValue;
        $row['aroma'] = $this->aroma->CurrentValue;
        $row['bahanaktif'] = $this->bahanaktif->CurrentValue;
        $row['warna'] = $this->warna->CurrentValue;
        $row['produk_warna_jenis'] = $this->produk_warna_jenis->CurrentValue;
        $row['aksesoris'] = $this->aksesoris->CurrentValue;
        $row['produk_lainlain'] = $this->produk_lainlain->CurrentValue;
        $row['statusproduk'] = $this->statusproduk->CurrentValue;
        $row['parfum'] = $this->parfum->CurrentValue;
        $row['catatan'] = $this->catatan->CurrentValue;
        $row['rencanakemasan'] = $this->rencanakemasan->CurrentValue;
        $row['keterangan'] = $this->keterangan->CurrentValue;
        $row['ekspetasiharga'] = $this->ekspetasiharga->CurrentValue;
        $row['kemasan'] = $this->kemasan->CurrentValue;
        $row['volume'] = $this->volume->CurrentValue;
        $row['jenistutup'] = $this->jenistutup->CurrentValue;
        $row['catatanpackaging'] = $this->catatanpackaging->CurrentValue;
        $row['infopackaging'] = $this->infopackaging->CurrentValue;
        $row['ukuran'] = $this->ukuran->CurrentValue;
        $row['desainprodukkemasan'] = $this->desainprodukkemasan->CurrentValue;
        $row['desaindiinginkan'] = $this->desaindiinginkan->CurrentValue;
        $row['mereknotifikasi'] = $this->mereknotifikasi->CurrentValue;
        $row['kategoristatus'] = $this->kategoristatus->CurrentValue;
        $row['kemasan_ukuran_satuan'] = $this->kemasan_ukuran_satuan->CurrentValue;
        $row['notifikasicatatan'] = $this->notifikasicatatan->CurrentValue;
        $row['label_ukuran'] = $this->label_ukuran->CurrentValue;
        $row['infolabel'] = $this->infolabel->CurrentValue;
        ...
        $row['createat'] = $this->createat->CurrentValue;
        $row['createby'] = $this->createby->CurrentValue;
        $row['statusdokumen'] = $this->statusdokumen->CurrentValue;
        $row['update_at'] = $this->update_at->CurrentValue;
        $row['status_data'] = $this->status_data->CurrentValue;
        $row['harga_rnd'] = $this->harga_rnd->CurrentValue;
        $row['aplikasi_sediaan'] = $this->aplikasi_sediaan->CurrentValue;
        $row['hu_hrg_isi'] = $this->hu_hrg_isi->CurrentValue;
        $row['hu_hrg_isi_pro'] = $this->hu_hrg_isi_pro->CurrentValue;
        $row['hu_hrg_kms_primer'] = $this->hu_hrg_kms_primer->CurrentValue;
        $row['hu_hrg_kms_primer_pro'] = $this->hu_hrg_kms_primer_pro->CurrentValue;
        $row['hu_hrg_kms_sekunder'] = $this->hu_hrg_kms_sekunder->CurrentValue;
        $row['hu_hrg_kms_sekunder_pro'] = $this->hu_hrg_kms_sekunder_pro->CurrentValue;
        $row['hu_hrg_label'] = $this->hu_hrg_label->CurrentValue;
        $row['hu_hrg_label_pro'] = $this->hu_hrg_label_pro->CurrentValue;
        $row['hu_hrg_total'] = $this->hu_hrg_total->CurrentValue;
        $row['hu_hrg_total_pro'] = $this->hu_hrg_total_pro->CurrentValue;
        $row['hl_hrg_isi'] = $this->hl_hrg_isi->CurrentValue;
        $row['hl_hrg_isi_pro'] = $this->hl_hrg_isi_pro->CurrentValue;
        $row['hl_hrg_kms_primer'] = $this->hl_hrg_kms_primer->CurrentValue;
        $row['hl_hrg_kms_primer_pro'] = $this->hl_hrg_kms_primer_pro->CurrentValue;
        $row['hl_hrg_kms_sekunder'] = $this->hl_hrg_kms_sekunder->CurrentValue;
        $row['hl_hrg_kms_sekunder_pro'] = $this->hl_hrg_kms_sekunder_pro->CurrentValue;
        $row['hl_hrg_label'] = $this->hl_hrg_label->CurrentValue;
        $row['hl_hrg_label_pro'] = $this->hl_hrg_label_pro->CurrentValue;
        $row['hl_hrg_total'] = $this->hl_hrg_total->CurrentValue;
        $row['hl_hrg_total_pro'] = $this->hl_hrg_total_pro->CurrentValue;
        $row['bs_bahan_aktif_tick'] = $this->bs_bahan_aktif_tick->CurrentValue;
        $row['bs_bahan_aktif'] = $this->bs_bahan_aktif->CurrentValue;
        $row['bs_bahan_lain'] = $this->bs_bahan_lain->CurrentValue;
        $row['bs_parfum'] = $this->bs_parfum->CurrentValue;
        $row['bs_estetika'] = $this->bs_estetika->CurrentValue;
        $row['bs_kms_wadah'] = $this->bs_kms_wadah->CurrentValue;
        $row['bs_kms_tutup'] = $this->bs_kms_tutup->CurrentValue;
        $row['bs_kms_sekunder'] = $this->bs_kms_sekunder->CurrentValue;
        $row['bs_label_desain'] = $this->bs_label_desain->CurrentValue;
        $row['bs_label_cetak'] = $this->bs_label_cetak->CurrentValue;
        $row['bs_label_lain'] = $this->bs_label_lain->CurrentValue;
        $row['dlv_pickup'] = $this->dlv_pickup->CurrentValue;
        $row['dlv_singlepoint'] = $this->dlv_singlepoint->CurrentValue;
        $row['dlv_multipoint'] = $this->dlv_multipoint->CurrentValue;
        $row['dlv_multipoint_jml'] = $this->dlv_multipoint_jml->CurrentValue;
        $row['dlv_term_lain'] = $this->dlv_term_lain->CurrentValue;
        $row['catatan_khusus'] = $this->catatan_khusus->CurrentValue;
        $row['aju_tgl'] = $this->aju_tgl->CurrentValue;
        $row['aju_oleh'] = $this->aju_oleh->CurrentValue;
        $row['proses_tgl'] = $this->proses_tgl->CurrentValue;
        $row['proses_oleh'] = $this->proses_oleh->CurrentValue;
        $row['revisi_tgl'] = $this->revisi_tgl->CurrentValue;
        $row['revisi_oleh'] = $this->revisi_oleh->CurrentValue;
        $row['revisi_akun_tgl'] = $this->revisi_akun_tgl->CurrentValue;
        $row['revisi_akun_oleh'] = $this->revisi_akun_oleh->CurrentValue;
        $row['revisi_rnd_tgl'] = $this->revisi_rnd_tgl->CurrentValue;
        $row['revisi_rnd_oleh'] = $this->revisi_rnd_oleh->CurrentValue;
        $row['rnd_tgl'] = $this->rnd_tgl->CurrentValue;
        $row['rnd_oleh'] = $this->rnd_oleh->CurrentValue;
        $row['ap_tgl'] = $this->ap_tgl->CurrentValue;
        $row['ap_oleh'] = $this->ap_oleh->CurrentValue;
        $row['batal_tgl'] = $this->batal_tgl->CurrentValue;
        $row['batal_oleh'] = $this->batal_oleh->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // cpo_jenis
        $this->cpo_jenis->setDbValueDef($rsnew, $this->cpo_jenis->CurrentValue, "", false);

        // ordernum
        $this->ordernum->setDbValueDef($rsnew, $this->ordernum->CurrentValue, null, false);

        // order_kode
        $this->order_kode->setDbValueDef($rsnew, $this->order_kode->CurrentValue, null, false);

        // orderterimatgl
        $this->orderterimatgl->setDbValueDef($rsnew, UnFormatDateTime($this->orderterimatgl->CurrentValue, 0), null, false);

        // produk_fungsi
        $this->produk_fungsi->setDbValueDef($rsnew, $this->produk_fungsi->CurrentValue, null, false);

        // produk_kualitas
        $this->produk_kualitas->setDbValueDef($rsnew, $this->produk_kualitas->CurrentValue, null, false);

        // produk_campaign
        $this->produk_campaign->setDbValueDef($rsnew, $this->produk_campaign->CurrentValue, null, false);

        // kemasan_satuan
        $this->kemasan_satuan->setDbValueDef($rsnew, $this->kemasan_satuan->CurrentValue, null, false);

        // ordertgl
        $this->ordertgl->setDbValueDef($rsnew, UnFormatDateTime($this->ordertgl->CurrentValue, 0), null, false);

        // custcode
        $this->custcode->setDbValueDef($rsnew, $this->custcode->CurrentValue, null, false);

        // perushnama
        $this->perushnama->setDbValueDef($rsnew, $this->perushnama->CurrentValue, null, false);

        // perushalamat
        $this->perushalamat->setDbValueDef($rsnew, $this->perushalamat->CurrentValue, null, false);

        // perushcp
        $this->perushcp->setDbValueDef($rsnew, $this->perushcp->CurrentValue, null, false);

        // perushjabatan
        $this->perushjabatan->setDbValueDef($rsnew, $this->perushjabatan->CurrentValue, null, false);

        // perushphone
        $this->perushphone->setDbValueDef($rsnew, $this->perushphone->CurrentValue, null, false);

        // perushmobile
        $this->perushmobile->setDbValueDef($rsnew, $this->perushmobile->CurrentValue, null, false);

        // bencmark
        $this->bencmark->setDbValueDef($rsnew, $this->bencmark->CurrentValue, null, false);
        ...
        // bentuksediaan
        $this->bentuksediaan->setDbValueDef($rsnew, $this->bentuksediaan->CurrentValue, null, false);

        // sediaan_ukuran
        $this->sediaan_ukuran->setDbValueDef($rsnew, $this->sediaan_ukuran->CurrentValue, null, false);

        // sediaan_ukuran_satuan
        $this->sediaan_ukuran_satuan->setDbValueDef($rsnew, $this->sediaan_ukuran_satuan->CurrentValue, null, false);

        // produk_viskositas
        $this->produk_viskositas->setDbValueDef($rsnew, $this->produk_viskositas->CurrentValue, null, false);

        // konsepproduk
        $this->konsepproduk->setDbValueDef($rsnew, $this->konsepproduk->CurrentValue, null, false);

        // fragrance
        $this->fragrance->setDbValueDef($rsnew, $this->fragrance->CurrentValue, null, false);
        ...
        // produk_warna_jenis
        $this->produk_warna_jenis->setDbValueDef($rsnew, $this->produk_warna_jenis->CurrentValue, null, false);

        // aksesoris
        $this->aksesoris->setDbValueDef($rsnew, $this->aksesoris->CurrentValue, null, false);

        // produk_lainlain
        $this->produk_lainlain->setDbValueDef($rsnew, $this->produk_lainlain->CurrentValue, null, false);

        // statusproduk
        $this->statusproduk->setDbValueDef($rsnew, $this->statusproduk->CurrentValue, null, false);
        ...
        // rencanakemasan
        $this->rencanakemasan->setDbValueDef($rsnew, $this->rencanakemasan->CurrentValue, null, false);

        // keterangan
        $this->keterangan->setDbValueDef($rsnew, $this->keterangan->CurrentValue, null, false);

        // ekspetasiharga
        $this->ekspetasiharga->setDbValueDef($rsnew, $this->ekspetasiharga->CurrentValue, null, false);

        // kemasan
        $this->kemasan->setDbValueDef($rsnew, $this->kemasan->CurrentValue, null, false);
        ...
        // catatanpackaging
        $this->catatanpackaging->setDbValueDef($rsnew, $this->catatanpackaging->CurrentValue, null, false);

        // infopackaging
        $this->infopackaging->setDbValueDef($rsnew, $this->infopackaging->CurrentValue, null, false);

        // ukuran
        $this->ukuran->setDbValueDef($rsnew, $this->ukuran->CurrentValue, null, false);

        // desainprodukkemasan
        $this->desainprodukkemasan->setDbValueDef($rsnew, $this->desainprodukkemasan->CurrentValue, null, false);

        // desaindiinginkan
        $this->desaindiinginkan->setDbValueDef($rsnew, $this->desaindiinginkan->CurrentValue, null, false);

        // mereknotifikasi
        $this->mereknotifikasi->setDbValueDef($rsnew, $this->mereknotifikasi->CurrentValue, null, false);

        // kategoristatus
        $this->kategoristatus->setDbValueDef($rsnew, $this->kategoristatus->CurrentValue, null, false);

        // kemasan_ukuran_satuan
        $this->kemasan_ukuran_satuan->setDbValueDef($rsnew, $this->kemasan_ukuran_satuan->CurrentValue, null, false);

        // notifikasicatatan
        $this->notifikasicatatan->setDbValueDef($rsnew, $this->notifikasicatatan->CurrentValue, null, false);

        // label_ukuran
        $this->label_ukuran->setDbValueDef($rsnew, $this->label_ukuran->CurrentValue, null, false);

        // infolabel
        $this->infolabel->setDbValueDef($rsnew, $this->infolabel->CurrentValue, null, false);
        ...
        // createat
        $this->createat->setDbValueDef($rsnew, UnFormatDateTime($this->createat->CurrentValue, 0), null, false);

        // createby
        $this->createby->setDbValueDef($rsnew, $this->createby->CurrentValue, null, false);

        // statusdokumen
        $this->statusdokumen->setDbValueDef($rsnew, $this->statusdokumen->CurrentValue, null, false);

        // update_at
        $this->update_at->setDbValueDef($rsnew, UnFormatDateTime($this->update_at->CurrentValue, 0), null, false);

        // status_data
        $this->status_data->setDbValueDef($rsnew, $this->status_data->CurrentValue, null, false);

        // harga_rnd
        $this->harga_rnd->setDbValueDef($rsnew, $this->harga_rnd->CurrentValue, null, false);

        // aplikasi_sediaan
        $this->aplikasi_sediaan->setDbValueDef($rsnew, $this->aplikasi_sediaan->CurrentValue, null, false);

        // hu_hrg_isi
        $this->hu_hrg_isi->setDbValueDef($rsnew, $this->hu_hrg_isi->CurrentValue, null, false);

        // hu_hrg_isi_pro
        $this->hu_hrg_isi_pro->setDbValueDef($rsnew, $this->hu_hrg_isi_pro->CurrentValue, null, false);

        // hu_hrg_kms_primer
        $this->hu_hrg_kms_primer->setDbValueDef($rsnew, $this->hu_hrg_kms_primer->CurrentValue, null, false);

        // hu_hrg_kms_primer_pro
        $this->hu_hrg_kms_primer_pro->setDbValueDef($rsnew, $this->hu_hrg_kms_primer_pro->CurrentValue, null, false);

        // hu_hrg_kms_sekunder
        $this->hu_hrg_kms_sekunder->setDbValueDef($rsnew, $this->hu_hrg_kms_sekunder->CurrentValue, null, false);

        // hu_hrg_kms_sekunder_pro
        $this->hu_hrg_kms_sekunder_pro->setDbValueDef($rsnew, $this->hu_hrg_kms_sekunder_pro->CurrentValue, null, false);

        // hu_hrg_label
        $this->hu_hrg_label->setDbValueDef($rsnew, $this->hu_hrg_label->CurrentValue, null, false);

        // hu_hrg_label_pro
        $this->hu_hrg_label_pro->setDbValueDef($rsnew, $this->hu_hrg_label_pro->CurrentValue, null, false);

        // hu_hrg_total
        $this->hu_hrg_total->setDbValueDef($rsnew, $this->hu_hrg_total->CurrentValue, null, false);

        // hu_hrg_total_pro
        $this->hu_hrg_total_pro->setDbValueDef($rsnew, $this->hu_hrg_total_pro->CurrentValue, null, false);

        // hl_hrg_isi
        $this->hl_hrg_isi->setDbValueDef($rsnew, $this->hl_hrg_isi->CurrentValue, null, false);

        // hl_hrg_isi_pro
        $this->hl_hrg_isi_pro->setDbValueDef($rsnew, $this->hl_hrg_isi_pro->CurrentValue, null, false);

        // hl_hrg_kms_primer
        $this->hl_hrg_kms_primer->setDbValueDef($rsnew, $this->hl_hrg_kms_primer->CurrentValue, null, false);

        // hl_hrg_kms_primer_pro
        $this->hl_hrg_kms_primer_pro->setDbValueDef($rsnew, $this->hl_hrg_kms_primer_pro->CurrentValue, null, false);

        // hl_hrg_kms_sekunder
        $this->hl_hrg_kms_sekunder->setDbValueDef($rsnew, $this->hl_hrg_kms_sekunder->CurrentValue, null, false);

        // hl_hrg_kms_sekunder_pro
        $this->hl_hrg_kms_sekunder_pro->setDbValueDef($rsnew, $this->hl_hrg_kms_sekunder_pro->CurrentValue, null, false);

        // hl_hrg_label
        $this->hl_hrg_label->setDbValueDef($rsnew, $this->hl_hrg_label->CurrentValue, null, false);

        // hl_hrg_label_pro
        $this->hl_hrg_label_pro->setDbValueDef($rsnew, $this->hl_hrg_label_pro->CurrentValue, null, false);

        // hl_hrg_total
        $this->hl_hrg_total->setDbValueDef($rsnew, $this->hl_hrg_total->CurrentValue, null, false);

        // hl_hrg_total_pro
        $this->hl_hrg_total_pro->setDbValueDef($rsnew, $this->hl_hrg_total_pro->CurrentValue, null, false);

        // bs_bahan_aktif_tick
        $this->bs_bahan_aktif_tick->setDbValueDef($rsnew, $this->bs_bahan_aktif_tick->CurrentValue, null, false);

        // bs_bahan_aktif
        $this->bs_bahan_aktif->setDbValueDef($rsnew, $this->bs_bahan_aktif->CurrentValue, null, false);

        // bs_bahan_lain
        $this->bs_bahan_lain->setDbValueDef($rsnew, $this->bs_bahan_lain->CurrentValue, null, false);

        // bs_parfum
        $this->bs_parfum->setDbValueDef($rsnew, $this->bs_parfum->CurrentValue, null, false);

        // bs_estetika
        $this->bs_estetika->setDbValueDef($rsnew, $this->bs_estetika->CurrentValue, null, false);

        // bs_kms_wadah
        $this->bs_kms_wadah->setDbValueDef($rsnew, $this->bs_kms_wadah->CurrentValue, null, false);

        // bs_kms_tutup
        $this->bs_kms_tutup->setDbValueDef($rsnew, $this->bs_kms_tutup->CurrentValue, null, false);

        // bs_kms_sekunder
        $this->bs_kms_sekunder->setDbValueDef($rsnew, $this->bs_kms_sekunder->CurrentValue, null, false);

        // bs_label_desain
        $this->bs_label_desain->setDbValueDef($rsnew, $this->bs_label_desain->CurrentValue, null, false);

        // bs_label_cetak
        $this->bs_label_cetak->setDbValueDef($rsnew, $this->bs_label_cetak->CurrentValue, null, false);

        // bs_label_lain
        $this->bs_label_lain->setDbValueDef($rsnew, $this->bs_label_lain->CurrentValue, null, false);

        // dlv_pickup
        $this->dlv_pickup->setDbValueDef($rsnew, $this->dlv_pickup->CurrentValue, null, false);

        // dlv_singlepoint
        $this->dlv_singlepoint->setDbValueDef($rsnew, $this->dlv_singlepoint->CurrentValue, null, false);

        // dlv_multipoint
        $this->dlv_multipoint->setDbValueDef($rsnew, $this->dlv_multipoint->CurrentValue, null, false);

        // dlv_multipoint_jml
        $this->dlv_multipoint_jml->setDbValueDef($rsnew, $this->dlv_multipoint_jml->CurrentValue, null, false);

        // dlv_term_lain
        $this->dlv_term_lain->setDbValueDef($rsnew, $this->dlv_term_lain->CurrentValue, null, false);

        // catatan_khusus
        $this->catatan_khusus->setDbValueDef($rsnew, $this->catatan_khusus->CurrentValue, null, false);

        // aju_tgl
        $this->aju_tgl->setDbValueDef($rsnew, UnFormatDateTime($this->aju_tgl->CurrentValue, 0), null, false);

        // aju_oleh
        $this->aju_oleh->setDbValueDef($rsnew, $this->aju_oleh->CurrentValue, null, false);

        // proses_tgl
        $this->proses_tgl->setDbValueDef($rsnew, UnFormatDateTime($this->proses_tgl->CurrentValue, 0), null, false);

        // proses_oleh
        $this->proses_oleh->setDbValueDef($rsnew, $this->proses_oleh->CurrentValue, null, false);

        // revisi_tgl
        $this->revisi_tgl->setDbValueDef($rsnew, UnFormatDateTime($this->revisi_tgl->CurrentValue, 0), null, false);

        // revisi_oleh
        $this->revisi_oleh->setDbValueDef($rsnew, $this->revisi_oleh->CurrentValue, null, false);

        // revisi_akun_tgl
        $this->revisi_akun_tgl->setDbValueDef($rsnew, UnFormatDateTime($this->revisi_akun_tgl->CurrentValue, 0), null, false);

        // revisi_akun_oleh
        $this->revisi_akun_oleh->setDbValueDef($rsnew, $this->revisi_akun_oleh->CurrentValue, null, false);

        // revisi_rnd_tgl
        $this->revisi_rnd_tgl->setDbValueDef($rsnew, UnFormatDateTime($this->revisi_rnd_tgl->CurrentValue, 0), null, false);

        // revisi_rnd_oleh
        $this->revisi_rnd_oleh->setDbValueDef($rsnew, $this->revisi_rnd_oleh->CurrentValue, null, false);

        // rnd_tgl
        $this->rnd_tgl->setDbValueDef($rsnew, UnFormatDateTime($this->rnd_tgl->CurrentValue, 0), null, false);

        // rnd_oleh
        $this->rnd_oleh->setDbValueDef($rsnew, $this->rnd_oleh->CurrentValue, null, false);

        // ap_tgl
        $this->ap_tgl->setDbValueDef($rsnew, UnFormatDateTime($this->ap_tgl->CurrentValue, 0), null, false);

        // ap_oleh
        $this->ap_oleh->setDbValueDef($rsnew, $this->ap_oleh->CurrentValue, null, false);

        // batal_tgl
        $this->batal_tgl->setDbValueDef($rsnew, UnFormatDateTime($this->batal_tgl->CurrentValue, 0), null, false);

        // batal_oleh
        $this->batal_oleh->setDbValueDef($rsnew, $this->batal_oleh->CurrentValue, null, false);
