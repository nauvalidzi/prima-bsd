...
class NpdReviewEdit extends NpdReview
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // bentukok
            $this->bentukok->setDbValueDef($rsnew, $this->bentukok->CurrentValue, 0, $this->bentukok->ReadOnly);

            // bentukrevisi
            $this->bentukrevisi->setDbValueDef($rsnew, $this->bentukrevisi->CurrentValue, null, $this->bentukrevisi->ReadOnly);

            // viskositasok
            $this->viskositasok->setDbValueDef($rsnew, $this->viskositasok->CurrentValue, 0, $this->viskositasok->ReadOnly);

            // viskositasrevisi
            $this->viskositasrevisi->setDbValueDef($rsnew, $this->viskositasrevisi->CurrentValue, null, $this->viskositasrevisi->ReadOnly);

            // jeniswarnaok
            $this->jeniswarnaok->setDbValueDef($rsnew, $this->jeniswarnaok->CurrentValue, 0, $this->jeniswarnaok->ReadOnly);

            // jeniswarnarevisi
            $this->jeniswarnarevisi->setDbValueDef($rsnew, $this->jeniswarnarevisi->CurrentValue, null, $this->jeniswarnarevisi->ReadOnly);

            // tonewarnaok
            $this->tonewarnaok->setDbValueDef($rsnew, $this->tonewarnaok->CurrentValue, 0, $this->tonewarnaok->ReadOnly);

            // tonewarnarevisi
            $this->tonewarnarevisi->setDbValueDef($rsnew, $this->tonewarnarevisi->CurrentValue, null, $this->tonewarnarevisi->ReadOnly);

            // gradasiwarnaok
            $this->gradasiwarnaok->setDbValueDef($rsnew, $this->gradasiwarnaok->CurrentValue, 0, $this->gradasiwarnaok->ReadOnly);

            // gradasiwarnarevisi
            $this->gradasiwarnarevisi->setDbValueDef($rsnew, $this->gradasiwarnarevisi->CurrentValue, null, $this->gradasiwarnarevisi->ReadOnly);

            // bauok
            $this->bauok->setDbValueDef($rsnew, $this->bauok->CurrentValue, 0, $this->bauok->ReadOnly);

            // baurevisi
            $this->baurevisi->setDbValueDef($rsnew, $this->baurevisi->CurrentValue, null, $this->baurevisi->ReadOnly);

            // estetikaok
            $this->estetikaok->setDbValueDef($rsnew, $this->estetikaok->CurrentValue, 0, $this->estetikaok->ReadOnly);

            // estetikarevisi
            $this->estetikarevisi->setDbValueDef($rsnew, $this->estetikarevisi->CurrentValue, null, $this->estetikarevisi->ReadOnly);

            // aplikasiawalok
            $this->aplikasiawalok->setDbValueDef($rsnew, $this->aplikasiawalok->CurrentValue, 0, $this->aplikasiawalok->ReadOnly);

            // aplikasiawalrevisi
            $this->aplikasiawalrevisi->setDbValueDef($rsnew, $this->aplikasiawalrevisi->CurrentValue, null, $this->aplikasiawalrevisi->ReadOnly);

            // aplikasilamaok
            $this->aplikasilamaok->setDbValueDef($rsnew, $this->aplikasilamaok->CurrentValue, 0, $this->aplikasilamaok->ReadOnly);

            // aplikasilamarevisi
            $this->aplikasilamarevisi->setDbValueDef($rsnew, $this->aplikasilamarevisi->CurrentValue, null, $this->aplikasilamarevisi->ReadOnly);

            // efekpositifok
            $this->efekpositifok->setDbValueDef($rsnew, $this->efekpositifok->CurrentValue, 0, $this->efekpositifok->ReadOnly);

            // efekpositifrevisi
            $this->efekpositifrevisi->setDbValueDef($rsnew, $this->efekpositifrevisi->CurrentValue, null, $this->efekpositifrevisi->ReadOnly);

            // efeknegatifok
            $this->efeknegatifok->setDbValueDef($rsnew, $this->efeknegatifok->CurrentValue, 0, $this->efeknegatifok->ReadOnly);

            // efeknegatifrevisi
            $this->efeknegatifrevisi->setDbValueDef($rsnew, $this->efeknegatifrevisi->CurrentValue, null, $this->efeknegatifrevisi->ReadOnly);

            // kesimpulan
            $this->kesimpulan->setDbValueDef($rsnew, $this->kesimpulan->CurrentValue, "", $this->kesimpulan->ReadOnly);
    ...
    public function pageDataRendering(&$header)
    {
        ...
        ";
        $this->bentukok->CustomMsg = "Gel/Krim/Cair/dll";
        $this->viskositasok->CustomMsg = "Encer/Sedang/Kental";
        $this->jeniswarnaok->CustomMsg = "Bening/Biru/Kuning/dll";
        $this->tonewarnaok->CustomMsg = "Gelap/Terang";
        $this->gradasiwarnaok->CustomMsg = "Transparan/Opaq";
        $this->bauok->CustomMsg = "Jenis/Kadar";
        $this->estetikaok->CustomMsg = "Bubble/Petal/Glitter/dll";
        $this->aplikasiawalok->CustomMsg = "Berat/Ringan/Lengket/Kering";
        $this->aplikasilamaok->CustomMsg = "Berat/Ringan/Lengket/Kering";
    }
