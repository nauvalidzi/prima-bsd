 ...
 * Page class
 */
class AlamatCustomerView extends AlamatCustomer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlamatCustomerView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "AlamatCustomerList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AlamatCustomerList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "AlamatCustomerList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
