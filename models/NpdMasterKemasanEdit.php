 ...
 * Page class
 */
class NpdMasterKemasanEdit extends NpdMasterKemasan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdMasterKemasanEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // subjenis
            $this->subjenis->setDbValueDef($rsnew, $this->subjenis->CurrentValue, null, $this->subjenis->ReadOnly);
