 ...
 * Page class
 */
class NpdSerahterimaList extends NpdSerahterima
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdSerahterimaList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fnpd_serahterimalist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "NpdSerahterimaDelete";
        $this->MultiUpdateUrl = "NpdSerahterimaUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fnpd_serahterimalistsrch";
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fnpd_serahterimalist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
