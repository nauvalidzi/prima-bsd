...
class VNpdCustomer extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // idkategoriproduk
        $this->idkategoriproduk = new DbField('v_npd_customer', 'v_npd_customer', 'x_idkategoriproduk', 'idkategoriproduk', '`idkategoriproduk`', '`idkategoriproduk`', 3, 11, -1, false, '`idkategoriproduk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idjenisproduk
        $this->idjenisproduk = new DbField('v_npd_customer', 'v_npd_customer', 'x_idjenisproduk', 'idjenisproduk', '`idjenisproduk`', '`idjenisproduk`', 3, 11, -1, false, '`idjenisproduk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        $this->idkategoriproduk->ViewValue = FormatNumber($this->idkategoriproduk->ViewValue, 0, -2, -2, -2);
        $this->idkategoriproduk->ViewCustomAttributes = "";

        // idjenisproduk
        $this->idjenisproduk->ViewValue = $this->idjenisproduk->CurrentValue;
        $this->idjenisproduk->ViewValue = FormatNumber($this->idjenisproduk->ViewValue, 0, -2, -2, -2);
    ...
    public function renderEditRow()
    {
        ...
        $this->idkategoriproduk->EditValue = $this->idkategoriproduk->CurrentValue;
        ...
        $this->idjenisproduk->EditValue = $this->idjenisproduk->CurrentValue;
