 ...
 * Page class
 */
class IjinbpomStatusDelete extends IjinbpomStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinbpomStatusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IjinbpomStatusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("IjinbpomStatusList"); // Return to list
            return;
        }
