 ...
 * Page class
 */
class NpdConfirmdesignView extends NpdConfirmdesign
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmdesignView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdConfirmdesignList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdConfirmdesignList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdConfirmdesignList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
