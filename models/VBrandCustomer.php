...
/**
 * Table class for v_brand_customer
 */
class VBrandCustomer extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_brand_customer';
        $this->TableName = 'v_brand_customer';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_brand_customer`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idbrand
        $this->idbrand = new DbField('v_brand_customer', 'v_brand_customer', 'x_idbrand', 'idbrand', '`idbrand`', '`idbrand`', 20, 20, -1, false, '`idbrand`', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_brand_customer`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VBrandCustomerList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VBrandCustomerView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VBrandCustomerEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VBrandCustomerAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VBrandCustomerView";
            case Config("API_ADD_ACTION"):
                return "VBrandCustomerAdd";
            case Config("API_EDIT_ACTION"):
                return "VBrandCustomerEdit";
            case Config("API_DELETE_ACTION"):
                return "VBrandCustomerDelete";
            case Config("API_LIST_ACTION"):
                return "VBrandCustomerList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VBrandCustomerView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VBrandCustomerView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VBrandCustomerAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VBrandCustomerAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VBrandCustomerEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VBrandCustomerAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VBrandCustomerDelete", $this->getUrlParm());
    }
