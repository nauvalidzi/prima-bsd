 ...
 * Page class
 */
class RedeembonusDelete extends Redeembonus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RedeembonusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RedeembonusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("RedeembonusList"); // Return to list
            return;
        }
