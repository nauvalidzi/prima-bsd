 ...
 * Page class
 */
class NpdLabelKualitasDelete extends NpdLabelKualitas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdLabelKualitasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdLabelKualitasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NpdLabelKualitasList"); // Return to list
                return;
            }
        }
