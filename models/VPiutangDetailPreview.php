 ...
 * Page class
 */
class VPiutangDetailPreview extends VPiutangDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VPiutangDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "v_piutang") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=v_piutang&" . GetForeignKeyUrl("fk_idcustomer", $this->idcustomer->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VPiutangDetailList"), "", $this->TableVar, true);
        $pageId = "preview";
