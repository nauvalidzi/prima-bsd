 ...
 * Page class
 */
class KpiMarketingDelete extends KpiMarketing
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KpiMarketingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KpiMarketingList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KpiMarketingList"); // Return to list
                return;
            }
        }
