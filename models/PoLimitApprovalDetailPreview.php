 ...
 * Page class
 */
class PoLimitApprovalDetailPreview extends PoLimitApprovalDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoLimitApprovalDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "po_limit_approval") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=po_limit_approval&" . GetForeignKeyUrl("fk_id", $this->idapproval->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "po_limit_approval") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->idapproval->setQueryStringValue($val);
            }
        }
    }
