 ...
 * Page class
 */
class RedeembonusView extends Redeembonus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RedeembonusView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "RedeembonusList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RedeembonusList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "RedeembonusList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RedeembonusList"), "", $this->TableVar, true);
        $pageId = "view";
