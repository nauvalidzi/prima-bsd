 ...
 * Page class
 */
class VListCustomerBrandsGrid extends VListCustomerBrands
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VListCustomerBrandsGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fv_list_customer_brandsgrid";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "VListCustomerBrandsAdd";
    ...
    protected function addRow($rsold = null)
    {
        ...
        $masterFilter = str_replace("@id@", AdjustSql($this->idcustomer->getSessionValue(), "DB"), $masterFilter);
        } else {
            $validMasterRecord = false;
        }
        if ($validMasterRecord) {
