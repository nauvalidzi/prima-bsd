 ...
 * Page class
 */
class StockOrderDelete extends StockOrder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockOrderDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StockOrderList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("StockOrderList"); // Return to list
                return;
            }
        }
