 ...
 * Page class
 */
class VOrderdetail2View extends VOrderdetail2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VOrderdetail2View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "VOrderdetail2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VOrderdetail2List"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VOrderdetail2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VOrderdetail2List"), "", $this->TableVar, true);
        $pageId = "view";
