 ...
 * Page class
 */
class KecamatanView extends Kecamatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KecamatanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "KecamatanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "KecamatanList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "KecamatanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
