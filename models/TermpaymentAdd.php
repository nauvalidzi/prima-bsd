 ...
 * Page class
 */
class TermpaymentAdd extends Termpayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TermpaymentAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("TermpaymentList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "TermpaymentList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "TermpaymentView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // value
        $this->value->setDbValueDef($rsnew, $this->value->CurrentValue, 0, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TermpaymentList"), "", $this->TableVar, true);
