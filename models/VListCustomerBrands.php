...
/**
 * Table class for v_list_customer_brands
 */
class VListCustomerBrands extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_list_customer_brands';
        $this->TableName = 'v_list_customer_brands';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_list_customer_brands`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idbrand
        $this->idbrand = new DbField('v_list_customer_brands', 'v_list_customer_brands', 'x_idbrand', 'idbrand', '`idbrand`', '`idbrand`', 20, 20, -1, false, '`idbrand`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kode_brand
        $this->kode_brand = new DbField('v_list_customer_brands', 'v_list_customer_brands', 'x_kode_brand', 'kode_brand', '`kode_brand`', '`kode_brand`', 200, 50, -1, false, '`kode_brand`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // nama_brand
        $this->nama_brand = new DbField('v_list_customer_brands', 'v_list_customer_brands', 'x_nama_brand', 'nama_brand', '`nama_brand`', '`nama_brand`', 200, 255, -1, false, '`nama_brand`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // jumlah_produk
        $this->jumlah_produk = new DbField('v_list_customer_brands', 'v_list_customer_brands', 'x_jumlah_produk', 'jumlah_produk', '`jumlah_produk`', '`jumlah_produk`', 20, 21, -1, false, '`jumlah_produk`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_list_customer_brands`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VListCustomerBrandsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "VListCustomerBrandsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VListCustomerBrandsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VListCustomerBrandsView";
            case Config("API_ADD_ACTION"):
                return "VListCustomerBrandsAdd";
            case Config("API_EDIT_ACTION"):
                return "VListCustomerBrandsEdit";
            case Config("API_DELETE_ACTION"):
                return "VListCustomerBrandsDelete";
            case Config("API_LIST_ACTION"):
                return "VListCustomerBrandsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VListCustomerBrandsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VListCustomerBrandsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VListCustomerBrandsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VListCustomerBrandsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VListCustomerBrandsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VListCustomerBrandsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VListCustomerBrandsDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        unset($rsnew['kode_brand']);
        unset($rsnew['nama_brand']);
