 ...
 * Page class
 */
class IjinhakiStatusDelete extends IjinhakiStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinhakiStatusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IjinhakiStatusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("IjinhakiStatusList"); // Return to list
            return;
        }
