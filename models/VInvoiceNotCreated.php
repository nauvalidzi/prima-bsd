...
/**
 * Table class for v_invoice_not_created
 */
class VInvoiceNotCreated extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_invoice_not_created';
        $this->TableName = 'v_invoice_not_created';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_invoice_not_created`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idorder
        $this->idorder = new DbField('v_invoice_not_created', 'v_invoice_not_created', 'x_idorder', 'idorder', '`idorder`', '`idorder`', 3, 11, -1, false, '`idorder`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // kodeorder
        $this->kodeorder = new DbField('v_invoice_not_created', 'v_invoice_not_created', 'x_kodeorder', 'kodeorder', '`kodeorder`', '`kodeorder`', 200, 50, -1, false, '`kodeorder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggalorder
        $this->tanggalorder = new DbField('v_invoice_not_created', 'v_invoice_not_created', 'x_tanggalorder', 'tanggalorder', '`tanggalorder`', CastDateFieldForLike("`tanggalorder`", 0, "DB"), 135, 19, 0, false, '`tanggalorder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idcustomer
        $this->idcustomer = new DbField('v_invoice_not_created', 'v_invoice_not_created', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 3, 11, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // kodecustomer
        $this->kodecustomer = new DbField('v_invoice_not_created', 'v_invoice_not_created', 'x_kodecustomer', 'kodecustomer', '`kodecustomer`', '`kodecustomer`', 200, 20, -1, false, '`kodecustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // namacustomer
        $this->namacustomer = new DbField('v_invoice_not_created', 'v_invoice_not_created', 'x_namacustomer', 'namacustomer', '`namacustomer`', '`namacustomer`', 200, 100, -1, false, '`namacustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_invoice_not_created`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VInvoiceNotCreatedList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VInvoiceNotCreatedView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VInvoiceNotCreatedEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VInvoiceNotCreatedAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VInvoiceNotCreatedView";
            case Config("API_ADD_ACTION"):
                return "VInvoiceNotCreatedAdd";
            case Config("API_EDIT_ACTION"):
                return "VInvoiceNotCreatedEdit";
            case Config("API_DELETE_ACTION"):
                return "VInvoiceNotCreatedDelete";
            case Config("API_LIST_ACTION"):
                return "VInvoiceNotCreatedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VInvoiceNotCreatedView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VInvoiceNotCreatedView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VInvoiceNotCreatedAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VInvoiceNotCreatedAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VInvoiceNotCreatedEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VInvoiceNotCreatedAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VInvoiceNotCreatedDelete", $this->getUrlParm());
    }
