...
class Product extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('product', 'product', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idkualitasbarang
        $this->idkualitasbarang = new DbField('product', 'product', 'x_idkualitasbarang', 'idkualitasbarang', '`idkualitasbarang`', '`idkualitasbarang`', 3, 11, -1, false, '`idkualitasbarang`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idproduct_acuan
        $this->idproduct_acuan = new DbField('product', 'product', 'x_idproduct_acuan', 'idproduct_acuan', '`idproduct_acuan`', '`idproduct_acuan`', 20, 20, -1, false, '`idproduct_acuan`', false, false, false, 'FORMATTED TEXT', 'SELECT');
