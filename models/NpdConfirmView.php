 ...
 * Page class
 */
class NpdConfirmView extends NpdConfirm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdConfirmList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdConfirmList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdConfirmList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
