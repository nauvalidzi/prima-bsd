 ...
 * Page class
 */
class NpdAplikasiSediaanAdd extends NpdAplikasiSediaan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdAplikasiSediaanAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("NpdAplikasiSediaanList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "NpdAplikasiSediaanList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "NpdAplikasiSediaanView") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("NpdAplikasiSediaanList"), "", $this->TableVar, true);
