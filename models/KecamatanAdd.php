 ...
 * Page class
 */
class KecamatanAdd extends Kecamatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KecamatanAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("KecamatanList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "KecamatanList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "KecamatanView") {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($curVal != "") {
                ...
                if ($this->idkabupaten->EditValue === null) { // Lookup from database
                    ...
                    if ($ari > 0) { // Lookup values found
                        $arwrk = $this->idkabupaten->Lookup->renderViewRow($rswrk[0]);
                        $this->idkabupaten->EditValue = $this->idkabupaten->displayValue($arwrk);
                    } else {
                        $this->idkabupaten->EditValue = HtmlEncode($this->idkabupaten->CurrentValue);
                    }
                }
            } else {
                $this->idkabupaten->EditValue = null;
            }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // idkabupaten
        $this->idkabupaten->setDbValueDef($rsnew, $this->idkabupaten->CurrentValue, 0, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("KecamatanList"), "", $this->TableVar, true);
