 ...
 * Page class
 */
class StocksAdd extends Stocks
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "StocksView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->prop_id->CurrentValue = null;
        $this->prop_id->OldValue = $this->prop_id->CurrentValue;
        $this->prop_code->CurrentValue = null;
        $this->prop_code->OldValue = $this->prop_code->CurrentValue;
        $this->idproduct->CurrentValue = null;
        $this->idproduct->OldValue = $this->idproduct->CurrentValue;
        $this->stok_masuk->CurrentValue = null;
        $this->stok_masuk->OldValue = $this->stok_masuk->CurrentValue;
        $this->stok_keluar->CurrentValue = null;
        $this->stok_keluar->OldValue = $this->stok_keluar->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['prop_id'] = $this->prop_id->CurrentValue;
        $row['prop_code'] = $this->prop_code->CurrentValue;
        $row['idproduct'] = $this->idproduct->CurrentValue;
        $row['stok_masuk'] = $this->stok_masuk->CurrentValue;
        $row['stok_keluar'] = $this->stok_keluar->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // prop_id
        $this->prop_id->setDbValueDef($rsnew, $this->prop_id->CurrentValue, 0, false);

        // prop_code
        $this->prop_code->setDbValueDef($rsnew, $this->prop_code->CurrentValue, "", false);

        // idproduct
        $this->idproduct->setDbValueDef($rsnew, $this->idproduct->CurrentValue, 0, false);

        // stok_masuk
        $this->stok_masuk->setDbValueDef($rsnew, $this->stok_masuk->CurrentValue, 0, false);

        // stok_keluar
        $this->stok_keluar->setDbValueDef($rsnew, $this->stok_keluar->CurrentValue, 0, false);
        ...
        $this->aktif->setDbValueDef($rsnew, $tmpBool, 0, strval($this->aktif->CurrentValue) == "");
