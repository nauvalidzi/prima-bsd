 ...
 * Page class
 */
class JenisbarangList extends Jenisbarang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisbarangList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "JenisbarangAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "JenisbarangDelete";
        $this->MultiUpdateUrl = "JenisbarangUpdate";
