 ...
 * Page class
 */
class StockOrderAdd extends StockOrder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockOrderAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("StockOrderList"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "StockOrderList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "StockOrderView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("stock_order_detail", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            if (in_array("stock_order_detail", $detailTblVar) && $detailPage->DetailAdd) {
                ...
                $Security->loadCurrentUserLevel($this->ProjectID . "stock_order_detail"); // Load user level of detail table
