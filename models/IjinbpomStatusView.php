 ...
 * Page class
 */
class IjinbpomStatusView extends IjinbpomStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinbpomStatusView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "IjinbpomStatusList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "IjinbpomStatusList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "IjinbpomStatusList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
