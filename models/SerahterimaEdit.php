 ...
 * Page class
 */
class SerahterimaEdit extends Serahterima
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SerahterimaEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // tanggalrequest
            $this->tanggalrequest->setDbValueDef($rsnew, UnFormatDateTime($this->tanggalrequest->CurrentValue, 0), CurrentDate(), $this->tanggalrequest->ReadOnly);

            // tanggalst
            $this->tanggalst->setDbValueDef($rsnew, UnFormatDateTime($this->tanggalst->CurrentValue, 0), CurrentDate(), $this->tanggalst->ReadOnly);
