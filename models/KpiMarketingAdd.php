 ...
 * Page class
 */
class KpiMarketingAdd extends KpiMarketing
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KpiMarketingAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("KpiMarketingList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "KpiMarketingList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "KpiMarketingView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // bulan
        $this->bulan->setDbValueDef($rsnew, UnFormatDateTime($this->bulan->CurrentValue, 7), null, false);
    ...
    {
    	$idpegawai = $this->idpegawai->FormValue;
        $bulan = $this->bulan->FormValue;
        if (check_kpi_existing($idpegawai, $bulan) !== TRUE) {
        	$customError = "Data dengan isian berikut telah ditambahkan.";
            return false;
        }
        return true;
    }
