 ...
 * Page class
 */
class NpdSerahterimaView extends NpdSerahterima
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdSerahterimaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdSerahterimaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdSerahterimaList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdSerahterimaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
