 ...
 * Page class
 */
class IjinhakiDelete extends Ijinhaki
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinhakiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IjinhakiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("IjinhakiList"); // Return to list
            return;
        }
