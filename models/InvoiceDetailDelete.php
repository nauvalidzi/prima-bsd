 ...
 * Page class
 */
class InvoiceDetailDelete extends InvoiceDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvoiceDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("InvoiceDetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("InvoiceDetailList"); // Return to list
            return;
        }
