 ...
 * Page class
 */
class StocksDelete extends Stocks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StocksDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StocksList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("StocksList"); // Return to list
                return;
            }
        }
