 ...
 * Page class
 */
class StockOrderDetailPreview extends StockOrderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockOrderDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "stock_order") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=stock_order&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
