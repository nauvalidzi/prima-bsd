...
class Ijinhaki extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('ijinhaki', 'ijinhaki', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idcustomer
        $this->idcustomer = new DbField('ijinhaki', 'ijinhaki', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 3, 11, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // idbrand
        $this->idbrand = new DbField('ijinhaki', 'ijinhaki', 'x_idbrand', 'idbrand', '`idbrand`', '`idbrand`', 3, 11, -1, false, '`idbrand`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // status
        $this->status = new DbField('ijinhaki', 'ijinhaki', 'x_status', 'status', '`status`', '`status`', 200, 50, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
