...
class Ijinhaki extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // idcustomer
        $this->idcustomer = new DbField('ijinhaki', 'ijinhaki', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 21, 20, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // idbrand
        $this->idbrand = new DbField('ijinhaki', 'ijinhaki', 'x_idbrand', 'idbrand', '`idbrand`', '`idbrand`', 21, 20, -1, false, '`idbrand`', false, false, false, 'FORMATTED TEXT', 'SELECT');
