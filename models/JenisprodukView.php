 ...
 * Page class
 */
class JenisprodukView extends Jenisproduk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisprodukView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "JenisprodukList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "JenisprodukList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "JenisprodukList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("JenisprodukList"), "", $this->TableVar, true);
        $pageId = "view";
