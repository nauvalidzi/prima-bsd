...
class NpdLabelKualitas extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('npd_label_kualitas', 'npd_label_kualitas', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
