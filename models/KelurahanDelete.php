 ...
 * Page class
 */
class KelurahanDelete extends Kelurahan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelurahanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KelurahanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KelurahanList"); // Return to list
                return;
            }
        }
