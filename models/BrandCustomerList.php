 ...
 * Page class
 */
class BrandCustomerList extends BrandCustomer
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'brand_customer';

    // Page object name
    public $PageObjName = "BrandCustomerList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fbrand_customerlist";
    ...
    public function __construct()
    {
        ...
        // Table object (brand_customer)
        if (!isset($GLOBALS["brand_customer"]) || get_class($GLOBALS["brand_customer"]) == PROJECT_NAMESPACE . "brand_customer") {
            $GLOBALS["brand_customer"] = &$this;
        }
        ...
        $this->AddUrl = "BrandCustomerAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "BrandCustomerDelete";
        $this->MultiUpdateUrl = "BrandCustomerUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'brand_customer');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fbrand_customerlistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("brand_customer"));
                $doc->Text = @$content;
    ...
    protected function loadSortOrder()
    {
        ...
        if ($orderBy == "") {
            $this->DefaultSort = "`idbrand` ASC,`idcustomer` ASC";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fbrand_customerlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fbrand_customerlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fbrand_customerlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
