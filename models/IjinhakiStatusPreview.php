 ...
 * Page class
 */
class IjinhakiStatusPreview extends IjinhakiStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinhakiStatusPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "ijinhaki") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ijinhaki&" . GetForeignKeyUrl("fk_id", $this->idijinhaki->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "ijinhaki") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->idijinhaki->setQueryStringValue($val);
            }
        }
    }
