 ...
 * Page class
 */
class StockOrderDetailDelete extends StockOrderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockOrderDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StockOrderDetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("StockOrderDetailList"); // Return to list
                return;
            }
        }
