 ...
 * Page class
 */
class NpdConfirmDelete extends NpdConfirm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdConfirmList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NpdConfirmList"); // Return to list
                return;
            }
        }
