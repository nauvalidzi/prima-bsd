 ...
 * Page class
 */
class NpdStatusView extends NpdStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdStatusView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdStatusList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdStatusList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdStatusList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
