 ...
 * Page class
 */
class IjinbpomDetailPreview extends IjinbpomDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinbpomDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "ijinbpom") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ijinbpom&" . GetForeignKeyUrl("fk_id", $this->idijinbpom->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "ijinbpom") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->idijinbpom->setQueryStringValue($val);
            }
        }
    }
