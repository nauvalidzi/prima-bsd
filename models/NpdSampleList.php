 ...
 * Page class
 */
class NpdSampleList extends NpdSample
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdSampleList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fnpd_samplelist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "NpdSampleDelete";
        $this->MultiUpdateUrl = "NpdSampleUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fnpd_samplelistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->idserahterima->AdvancedSearch->toJson(), ","); // Field idserahterima
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fnpd_samplelistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field idserahterima
        $this->idserahterima->AdvancedSearch->SearchValue = @$filter["x_idserahterima"];
        $this->idserahterima->AdvancedSearch->SearchOperator = @$filter["z_idserahterima"];
        $this->idserahterima->AdvancedSearch->SearchCondition = @$filter["v_idserahterima"];
        $this->idserahterima->AdvancedSearch->SearchValue2 = @$filter["y_idserahterima"];
        $this->idserahterima->AdvancedSearch->SearchOperator2 = @$filter["w_idserahterima"];
        $this->idserahterima->AdvancedSearch->save();
        ...
        $this->fungsi->AdvancedSearch->SearchOperator = @$filter["z_fungsi"];
        $this->fungsi->AdvancedSearch->SearchCondition = @$filter["v_fungsi"];
        $this->fungsi->AdvancedSearch->SearchValue2 = @$filter["y_fungsi"];
        $this->fungsi->AdvancedSearch->SearchOperator2 = @$filter["w_fungsi"];
        $this->fungsi->AdvancedSearch->save();
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fnpd_samplelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fnpd_samplelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fnpd_samplelist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fnpd_samplelistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
