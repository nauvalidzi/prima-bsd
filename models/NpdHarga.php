...
class NpdHarga extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // idnpd
        $this->idnpd = new DbField('npd_harga', 'npd_harga', 'x_idnpd', 'idnpd', '`idnpd`', '`idnpd`', 21, 20, -1, false, '`idnpd`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // idnpd_sample
        $this->idnpd_sample = new DbField('npd_harga', 'npd_harga', 'x_idnpd_sample', 'idnpd_sample', '`idnpd_sample`', '`idnpd_sample`', 21, 20, -1, false, '`idnpd_sample`', false, false, false, 'FORMATTED TEXT', 'SELECT');
