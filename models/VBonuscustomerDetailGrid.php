 ...
 * Page class
 */
class VBonuscustomerDetailGrid extends VBonuscustomerDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VBonuscustomerDetailGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fv_bonuscustomer_detailgrid";
    ...
    {
        $this->blackbonus->FormValue = ""; // Clear form value
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->blackbonus->EditValue) != "" && is_numeric($this->blackbonus->EditValue)) {
                ...
                $this->blackbonus->OldValue = $this->blackbonus->EditValue;
            }
    ...
    protected function validateForm()
    {
        ...
        if (!CheckNumber($this->blackbonus->FormValue)) {
