 ...
 * Page class
 */
class NpdSampleAdd extends NpdSample
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdSampleAdd";
    ...
    public function run()
    {
        ...
        $this->idserahterima->setVisibility();
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "NpdSampleView") {
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'idserahterima' first before field var 'x_idserahterima'
        $val = $CurrentForm->hasValue("idserahterima") ? $CurrentForm->getValue("idserahterima") : $CurrentForm->getValue("x_idserahterima");
        if (!$this->idserahterima->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->idserahterima->Visible = false; // Disable update for API request
            } else {
                $this->idserahterima->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->idserahterima->CurrentValue = $this->idserahterima->FormValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->idserahterima->getSessionValue() != "") {
                ...
                $this->idserahterima->EditValue = HtmlEncode($this->idserahterima->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->idserahterima->Required) {
            if (!$this->idserahterima->IsDetailKey && EmptyValue($this->idserahterima->FormValue)) {
                $this->idserahterima->addErrorMessage(str_replace("%s", $this->idserahterima->caption(), $this->idserahterima->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->idserahterima->FormValue)) {
            $this->idserahterima->addErrorMessage($this->idserahterima->getErrorMessage(false));
        }
