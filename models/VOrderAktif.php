...
/**
 * Table class for v_order_aktif
 */
class VOrderAktif extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_order_aktif';
        $this->TableName = 'v_order_aktif';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_order_aktif`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idorder
        $this->idorder = new DbField('v_order_aktif', 'v_order_aktif', 'x_idorder', 'idorder', '`idorder`', '`idorder`', 3, 11, -1, false, '`idorder`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // kodeorder
        $this->kodeorder = new DbField('v_order_aktif', 'v_order_aktif', 'x_kodeorder', 'kodeorder', '`kodeorder`', '`kodeorder`', 200, 50, -1, false, '`kodeorder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idcustomer
        $this->idcustomer = new DbField('v_order_aktif', 'v_order_aktif', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 3, 11, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // kodecustomer
        $this->kodecustomer = new DbField('v_order_aktif', 'v_order_aktif', 'x_kodecustomer', 'kodecustomer', '`kodecustomer`', '`kodecustomer`', 200, 20, -1, false, '`kodecustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // namacustomer
        $this->namacustomer = new DbField('v_order_aktif', 'v_order_aktif', 'x_namacustomer', 'namacustomer', '`namacustomer`', '`namacustomer`', 200, 100, -1, false, '`namacustomer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggalorder
        $this->tanggalorder = new DbField('v_order_aktif', 'v_order_aktif', 'x_tanggalorder', 'tanggalorder', '`tanggalorder`', CastDateFieldForLike("`tanggalorder`", 0, "DB"), 135, 19, 0, false, '`tanggalorder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_order_aktif`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VOrderAktifList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VOrderAktifView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VOrderAktifEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VOrderAktifAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VOrderAktifView";
            case Config("API_ADD_ACTION"):
                return "VOrderAktifAdd";
            case Config("API_EDIT_ACTION"):
                return "VOrderAktifEdit";
            case Config("API_DELETE_ACTION"):
                return "VOrderAktifDelete";
            case Config("API_LIST_ACTION"):
                return "VOrderAktifList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VOrderAktifView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VOrderAktifView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VOrderAktifAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VOrderAktifAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VOrderAktifEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VOrderAktifAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VOrderAktifDelete", $this->getUrlParm());
    }
