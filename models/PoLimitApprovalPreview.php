 ...
 * Page class
 */
class PoLimitApprovalPreview extends PoLimitApproval
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoLimitApprovalPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "po_limit_approval_detail") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=po_limit_approval_detail&" . GetForeignKeyUrl("fk_idapproval", $this->id->QueryStringValue) . "";
        }
        return $url;
    }
