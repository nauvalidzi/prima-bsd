...
class StockEdit extends Stock
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->idorder_detail->EditValue = HtmlEncode($this->idorder_detail->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->idorder_detail->FormValue)) {
            $this->idorder_detail->addErrorMessage($this->idorder_detail->getErrorMessage(false));
        }
