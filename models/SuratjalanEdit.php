 ...
 * Page class
 */
class SuratjalanEdit extends Suratjalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SuratjalanEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("suratjalan_detail", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // tglsurat
            $this->tglsurat->setDbValueDef($rsnew, UnFormatDateTime($this->tglsurat->CurrentValue, 0), CurrentDate(), $this->tglsurat->ReadOnly);

            // tglkirim
            $this->tglkirim->setDbValueDef($rsnew, UnFormatDateTime($this->tglkirim->CurrentValue, 0), CurrentDate(), $this->tglkirim->ReadOnly);

            // idalamat_customer
            $this->idalamat_customer->setDbValueDef($rsnew, $this->idalamat_customer->CurrentValue, 0, $this->idalamat_customer->ReadOnly);
