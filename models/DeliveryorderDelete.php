 ...
 * Page class
 */
class DeliveryorderDelete extends Deliveryorder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DeliveryorderDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DeliveryorderList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("DeliveryorderList"); // Return to list
            return;
        }
