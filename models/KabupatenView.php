 ...
 * Page class
 */
class KabupatenView extends Kabupaten
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KabupatenView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "KabupatenList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "KabupatenList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "KabupatenList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
