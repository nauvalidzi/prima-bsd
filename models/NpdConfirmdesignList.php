 ...
 * Page class
 */
class NpdConfirmdesignList extends NpdConfirmdesign
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmdesignList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fnpd_confirmdesignlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "NpdConfirmdesignAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "NpdConfirmdesignDelete";
        $this->MultiUpdateUrl = "NpdConfirmdesignUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fnpd_confirmdesignlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->tglprimer->AdvancedSearch->toJson(), ","); // Field tglprimer
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fnpd_confirmdesignlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->desaindepan->AdvancedSearch->SearchCondition = @$filter["v_desaindepan"];
        $this->desaindepan->AdvancedSearch->SearchValue2 = @$filter["y_desaindepan"];
        $this->desaindepan->AdvancedSearch->SearchOperator2 = @$filter["w_desaindepan"];
        $this->desaindepan->AdvancedSearch->save();

        // Field desainbelakang
        $this->desainbelakang->AdvancedSearch->SearchValue = @$filter["x_desainbelakang"];
        $this->desainbelakang->AdvancedSearch->SearchOperator = @$filter["z_desainbelakang"];
        $this->desainbelakang->AdvancedSearch->SearchCondition = @$filter["v_desainbelakang"];
        $this->desainbelakang->AdvancedSearch->SearchValue2 = @$filter["y_desainbelakang"];
        $this->desainbelakang->AdvancedSearch->SearchOperator2 = @$filter["w_desainbelakang"];
        $this->desainbelakang->AdvancedSearch->save();
        ...
        // Field tglprimer
        $this->tglprimer->AdvancedSearch->SearchValue = @$filter["x_tglprimer"];
        $this->tglprimer->AdvancedSearch->SearchOperator = @$filter["z_tglprimer"];
        $this->tglprimer->AdvancedSearch->SearchCondition = @$filter["v_tglprimer"];
        $this->tglprimer->AdvancedSearch->SearchValue2 = @$filter["y_tglprimer"];
        $this->tglprimer->AdvancedSearch->SearchOperator2 = @$filter["w_tglprimer"];
        $this->tglprimer->AdvancedSearch->save();
        ...
        // Field catatansekunder
        $this->catatansekunder->AdvancedSearch->SearchValue = @$filter["x_catatansekunder"];
        $this->catatansekunder->AdvancedSearch->SearchOperator = @$filter["z_catatansekunder"];
        $this->catatansekunder->AdvancedSearch->SearchCondition = @$filter["v_catatansekunder"];
        $this->catatansekunder->AdvancedSearch->SearchValue2 = @$filter["y_catatansekunder"];
        $this->catatansekunder->AdvancedSearch->SearchOperator2 = @$filter["w_catatansekunder"];
        $this->catatansekunder->AdvancedSearch->save();

        // Field tglsekunder
        $this->tglsekunder->AdvancedSearch->SearchValue = @$filter["x_tglsekunder"];
        $this->tglsekunder->AdvancedSearch->SearchOperator = @$filter["z_tglsekunder"];
        $this->tglsekunder->AdvancedSearch->SearchCondition = @$filter["v_tglsekunder"];
        $this->tglsekunder->AdvancedSearch->SearchValue2 = @$filter["y_tglsekunder"];
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->desaindepan, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->desainbelakang, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->catatansekunder, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fnpd_confirmdesignlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fnpd_confirmdesignlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fnpd_confirmdesignlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fnpd_confirmdesignlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
