...
class InvoiceList extends Invoice
{
    ...
    public function listOptionsLoad()
    {
        ...
        $item->Header = "Print";
        $item = &$this->ListOptions->add("suratjalan");
        $item->Header = "Surat Jalan";
    }
    ...
    public function listOptionsRendered()
    {
        ...
        $this->ListOptions->Items["print"]->Body = "<a href=\"PrintInvoice?id={$this->id->CurrentValue}\" target=\"_blank\">Print Invoice</a>";
        if ($this->sent->CurrentValue == 1) {
        	$this->ListOptions->Items["suratjalan"]->Body = 'Sent';
        } else {
