 ...
 * Page class
 */
class LevelCustomerView extends LevelCustomer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LevelCustomerView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LevelCustomerList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LevelCustomerList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "LevelCustomerList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
