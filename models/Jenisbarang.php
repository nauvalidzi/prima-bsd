...
class Jenisbarang extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("JenisbarangList");
    }
    ...
    {
        global $Language;
        if ($pageName == "JenisbarangView") {
            return $Language->phrase("View");
        } elseif ($pageName == "JenisbarangEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "JenisbarangAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "JenisbarangAdd";
            case Config("API_EDIT_ACTION"):
                return "JenisbarangEdit";
            case Config("API_DELETE_ACTION"):
                return "JenisbarangDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("JenisbarangView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("JenisbarangView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "JenisbarangAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "JenisbarangAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("JenisbarangEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("JenisbarangAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("JenisbarangDelete", $this->getUrlParm());
    }
