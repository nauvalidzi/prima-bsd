 ...
 * Page class
 */
class StockDeliveryorderDelete extends StockDeliveryorder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockDeliveryorderDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StockDeliveryorderList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("StockDeliveryorderList"); // Return to list
                return;
            }
        }
