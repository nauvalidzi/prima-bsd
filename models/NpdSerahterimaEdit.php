...
class NpdSerahterimaEdit extends NpdSerahterima
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // tgl_request
            $this->tgl_request->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_request->CurrentValue, 0), CurrentDate(), $this->tgl_request->ReadOnly);

            // tgl_serahterima
            $this->tgl_serahterima->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_serahterima->CurrentValue, 0), CurrentDate(), $this->tgl_serahterima->ReadOnly);
