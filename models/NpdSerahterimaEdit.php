 ...
 * Page class
 */
class NpdSerahterimaEdit extends NpdSerahterima
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdSerahterimaEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // tanggal_request
            $this->tanggal_request->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal_request->CurrentValue, 0), CurrentDate(), $this->tanggal_request->ReadOnly);

            // tanggal_serahterima
            $this->tanggal_serahterima->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal_serahterima->CurrentValue, 0), CurrentDate(), $this->tanggal_serahterima->ReadOnly);

            // jenis_produk
            $this->jenis_produk->setDbValueDef($rsnew, $this->jenis_produk->CurrentValue, "", $this->jenis_produk->ReadOnly);
            ...
            $this->readonly->setDbValueDef($rsnew, $tmpBool, 0, $this->readonly->ReadOnly);
