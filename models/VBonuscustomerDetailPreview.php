 ...
 * Page class
 */
class VBonuscustomerDetailPreview extends VBonuscustomerDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VBonuscustomerDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "v_bonuscustomer") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=v_bonuscustomer&" . GetForeignKeyUrl("fk_idcustomer", $this->idcustomer->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VBonuscustomerDetailList"), "", $this->TableVar, true);
        $pageId = "preview";
