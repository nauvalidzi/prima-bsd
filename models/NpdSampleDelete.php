 ...
 * Page class
 */
class NpdSampleDelete extends NpdSample
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdSampleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NpdSampleList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("NpdSampleList"); // Return to list
            return;
        }
