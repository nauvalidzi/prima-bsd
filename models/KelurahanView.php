 ...
 * Page class
 */
class KelurahanView extends Kelurahan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelurahanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "KelurahanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "KelurahanList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "KelurahanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
