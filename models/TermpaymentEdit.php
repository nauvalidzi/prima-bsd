 ...
 * Page class
 */
class TermpaymentEdit extends Termpayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TermpaymentEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // value
            $this->value->setDbValueDef($rsnew, $this->value->CurrentValue, 0, $this->value->ReadOnly);
