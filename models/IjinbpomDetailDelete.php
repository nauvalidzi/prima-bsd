 ...
 * Page class
 */
class IjinbpomDetailDelete extends IjinbpomDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IjinbpomDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IjinbpomDetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("IjinbpomDetailList"); // Return to list
                return;
            }
        }
