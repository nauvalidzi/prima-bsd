 ...
 * Page class
 */
class NpdConfirmdummyView extends NpdConfirmdummy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmdummyView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdConfirmdummyList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdConfirmdummyList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdConfirmdummyList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
