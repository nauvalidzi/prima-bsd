...
class Ijinbpom extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('ijinbpom', 'ijinbpom', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idcustomer
        $this->idcustomer = new DbField('ijinbpom', 'ijinbpom', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 3, 11, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // idbrand
        $this->idbrand = new DbField('ijinbpom', 'ijinbpom', 'x_idbrand', 'idbrand', '`idbrand`', '`idbrand`', 3, 11, -1, false, '`idbrand`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->idbrand->Lookup = new Lookup('idbrand', 'brand', false, 'id', ["kode","title","",""], ["x_idcustomer"], ["ijinbpom_detail x_idnpd"], ["idcustomer"], ["x_idcustomer"], [], [], '', '');
                break;
            default:
                $this->idbrand->Lookup = new Lookup('idbrand', 'brand', false, 'id', ["kode","title","",""], ["x_idcustomer"], ["ijinbpom_detail x_idnpd"], ["idcustomer"], ["x_idcustomer"], [], [], '', '');
                break;
