 ...
 * Page class
 */
class NpdConfirmEdit extends NpdConfirm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdConfirmEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // alamatpemesan
            $this->alamatpemesan->setDbValueDef($rsnew, $this->alamatpemesan->CurrentValue, "", $this->alamatpemesan->ReadOnly);
