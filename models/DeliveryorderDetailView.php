 ...
 * Page class
 */
class DeliveryorderDetailView extends DeliveryorderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DeliveryorderDetailView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "DeliveryorderDetailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DeliveryorderDetailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "DeliveryorderDetailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
