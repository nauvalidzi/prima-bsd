 ...
 * Page class
 */
class NpdMasterSpesifikasiView extends NpdMasterSpesifikasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NpdMasterSpesifikasiView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NpdMasterSpesifikasiList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NpdMasterSpesifikasiList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NpdMasterSpesifikasiList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
