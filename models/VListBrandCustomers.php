...
/**
 * Table class for v_list_brand_customers
 */
class VListBrandCustomers extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_list_brand_customers';
        $this->TableName = 'v_list_brand_customers';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_list_brand_customers`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idcustomer
        $this->idcustomer = new DbField('v_list_brand_customers', 'v_list_brand_customers', 'x_idcustomer', 'idcustomer', '`idcustomer`', '`idcustomer`', 20, 20, -1, false, '`idcustomer`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->idcustomer->Lookup = new Lookup('idcustomer', 'customer', false, 'id', ["kode","nama","",""], [], [], [], [], ["kode","nama"], ["x_kode_customer","x_nama_customer"], '', '');
                break;
            default:
                $this->idcustomer->Lookup = new Lookup('idcustomer', 'customer', false, 'id', ["kode","nama","",""], [], [], [], [], ["kode","nama"], ["x_kode_customer","x_nama_customer"], '', '');
                break;
        ...
        // kode_customer
        $this->kode_customer = new DbField('v_list_brand_customers', 'v_list_brand_customers', 'x_kode_customer', 'kode_customer', '`kode_customer`', '`kode_customer`', 200, 50, -1, false, '`kode_customer`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // nama_customer
        $this->nama_customer = new DbField('v_list_brand_customers', 'v_list_brand_customers', 'x_nama_customer', 'nama_customer', '`nama_customer`', '`nama_customer`', 200, 255, -1, false, '`nama_customer`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_list_brand_customers`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VListBrandCustomersList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VListBrandCustomersView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VListBrandCustomersEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VListBrandCustomersAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VListBrandCustomersView";
            case Config("API_ADD_ACTION"):
                return "VListBrandCustomersAdd";
            case Config("API_EDIT_ACTION"):
                return "VListBrandCustomersEdit";
            case Config("API_DELETE_ACTION"):
                return "VListBrandCustomersDelete";
            case Config("API_LIST_ACTION"):
                return "VListBrandCustomersList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VListBrandCustomersView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VListBrandCustomersView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VListBrandCustomersAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VListBrandCustomersAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VListBrandCustomersEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VListBrandCustomersAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VListBrandCustomersDelete", $this->getUrlParm());
    }
