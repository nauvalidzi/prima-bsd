...
/**
 * Table class for ijinhaki_status
 */
class IjinhakiStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'ijinhaki_status';
        $this->TableName = 'ijinhaki_status';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`ijinhaki_status`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        $this->Fields['idijinhaki'] = &$this->idijinhaki;

        // idpegawai
        $this->idpegawai = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_idpegawai', 'idpegawai', '`idpegawai`', '`idpegawai`', 3, 11, -1, false, '`idpegawai`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // status
        $this->status = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_status', 'status', '`status`', '`status`', 200, 50, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // targetmulai
        $this->targetmulai = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_targetmulai', 'targetmulai', '`targetmulai`', CastDateFieldForLike("`targetmulai`", 0, "DB"), 135, 19, 0, false, '`targetmulai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglmulai
        $this->tglmulai = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_tglmulai', 'tglmulai', '`tglmulai`', CastDateFieldForLike("`tglmulai`", 0, "DB"), 135, 19, 0, false, '`tglmulai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // targetselesai
        $this->targetselesai = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_targetselesai', 'targetselesai', '`targetselesai`', CastDateFieldForLike("`targetselesai`", 0, "DB"), 135, 19, 0, false, '`targetselesai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglselesai
        $this->tglselesai = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_tglselesai', 'tglselesai', '`tglselesai`', CastDateFieldForLike("`tglselesai`", 0, "DB"), 135, 19, 0, false, '`tglselesai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // keterangan
        $this->keterangan = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 255, -1, false, '`keterangan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->keterangan->Sortable = true; // Allow sort
        $this->keterangan->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->keterangan->Param, "CustomMsg");
        $this->Fields['keterangan'] = &$this->keterangan;

        // lampiran
        $this->lampiran = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_lampiran', 'lampiran', '`lampiran`', '`lampiran`', 200, 255, -1, true, '`lampiran`', false, false, false, 'FORMATTED TEXT', 'FILE');
        ...
        // created_by
        $this->created_by = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, 11, -1, false, '`created_by`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // created_at
        $this->created_at = new DbField('ijinhaki_status', 'ijinhaki_status', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, false, '`created_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "ijinhaki") {
            if ($this->idijinhaki->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->idijinhaki->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "ijinhaki") {
            if ($this->idijinhaki->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`idijinhaki`", $this->idijinhaki->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_ijinhaki()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_ijinhaki()
    {
        return "`idijinhaki`=@idijinhaki@";
    }

    // Table level SQL
    public function getSqlFrom() // From
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`ijinhaki_status`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idijinhaki->DbValue = $row['idijinhaki'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("IjinhakiStatusList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "IjinhakiStatusEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "IjinhakiStatusAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "IjinhakiStatusView";
            case Config("API_ADD_ACTION"):
                return "IjinhakiStatusAdd";
            case Config("API_EDIT_ACTION"):
                return "IjinhakiStatusEdit";
            case Config("API_DELETE_ACTION"):
                return "IjinhakiStatusDelete";
            case Config("API_LIST_ACTION"):
                return "IjinhakiStatusList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("IjinhakiStatusView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("IjinhakiStatusView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "IjinhakiStatusAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "IjinhakiStatusAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("IjinhakiStatusEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("IjinhakiStatusAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("IjinhakiStatusDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "ijinhaki" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->idijinhaki->CurrentValue ?? $this->idijinhaki->getSessionValue());
        }
        return $url;
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // idijinhaki
        $this->idijinhaki->LinkCustomAttributes = "";
        $this->idijinhaki->HrefValue = "";
        $this->idijinhaki->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->idijinhaki->EditCustomAttributes = "";
        if ($this->idijinhaki->getSessionValue() != "") {
            $this->idijinhaki->CurrentValue = GetForeignKeyValue($this->idijinhaki->getSessionValue());
            $this->idijinhaki->ViewValue = $this->idijinhaki->CurrentValue;
            $this->idijinhaki->ViewValue = FormatNumber($this->idijinhaki->ViewValue, 0, -2, -2, -2);
            $this->idijinhaki->ViewCustomAttributes = "";
        } else {
            $this->idijinhaki->EditValue = $this->idijinhaki->CurrentValue;
            $this->idijinhaki->PlaceHolder = RemoveHtml($this->idijinhaki->caption());
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->idijinhaki);
                    $doc->exportCaption($this->idpegawai);
                    $doc->exportCaption($this->status);
                    $doc->exportCaption($this->targetmulai);
                    $doc->exportCaption($this->tglmulai);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->idijinhaki);
                        $doc->exportField($this->idpegawai);
                        $doc->exportField($this->status);
                        $doc->exportField($this->targetmulai);
                        $doc->exportField($this->tglmulai);
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `ijinhaki_status`";
    ...
    {
        $filterWrk = $filter;
        if ($currentMasterTable == "ijinhaki") {
            $filterWrk = Container("ijinhaki")->addUserIDFilter($filterWrk);
        }
        return $filterWrk;
    }
    ...
    public function addDetailUserIDFilter($filter, $currentMasterTable)
    {
        $filterWrk = $filter;
        if ($currentMasterTable == "ijinhaki") {
            $mastertable = Container("ijinhaki");
            if (!$mastertable->userIdAllow()) {
                $subqueryWrk = $mastertable->getUserIDSubquery($this->idijinhaki, $mastertable->id);
    ...
    {
        //Log("Row Inserted");
        updateStatus("ijinhaki", $rsnew['idijinhaki']);
    }
    ...
    {
        //Log("Row Updated");
        updateStatus("ijinhaki", $rsold['idijinhaki']);
    }
    ...
    {
        //Log("Row Deleted");
        updateStatus("ijinhaki", $rs['idijinhaki']);
    }
