 ...
 * Page class
 */
class ChangePassword extends Pegawai
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("pegawai", "pegawai", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("pegawai", "pegawai", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-control");
        $this->ConfirmPassword = new DbField("pegawai", "pegawai", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);
