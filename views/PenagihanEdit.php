...
loadjs.ready("head", function () {
    ...
    fpenagihanedit = currentForm = new ew.Form("fpenagihanedit", "edit");
    ...
    // Validate form
    fpenagihanedit.validate = function () {
    ...
    // Form_CustomValidate
    fpenagihanedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpenagihanedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpenagihanedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("fpenagihanedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpenagihanedit" id="fpenagihanedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_penagihan_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<script>
loadjs.ready(["fpenagihanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenagihanedit", "x_tgl_order", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpenagihanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenagihanedit", "x_tgl_faktur", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpenagihanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenagihanedit", "x_tgl_antrian", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->status->isInvalidClass() ?>" data-table="penagihan" data-field="x_status" name="x_status[]" id="x_status_911837" value="1"<?= ConvertToBool($Page->status->CurrentValue) ? " checked" : "" ?><?= $Page->status->editAttributes() ?> aria-describedby="x_status_help">
    <label class="custom-control-label" for="x_status_911837"></label>
</div>
...
<script>
loadjs.ready(["fpenagihanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenagihanedit", "x_tgl_penagihan", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpenagihanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenagihanedit", "x_tgl_return", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpenagihanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenagihanedit", "x_tgl_cancel", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
