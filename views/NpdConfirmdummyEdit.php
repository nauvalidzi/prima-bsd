...
// Page object
$NpdConfirmdummyEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fnpd_confirmdummyedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fnpd_confirmdummyedit = currentForm = new ew.Form("fnpd_confirmdummyedit", "edit");
    ...
    fnpd_confirmdummyedit.addFields([
    ...
    // Validate form
    fnpd_confirmdummyedit.validate = function () {
    ...
    // Form_CustomValidate
    fnpd_confirmdummyedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnpd_confirmdummyedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fnpd_confirmdummyedit.lists.checked1_by = <?= $Page->checked1_by->toClientList($Page) ?>;
    fnpd_confirmdummyedit.lists.approved_by = <?= $Page->approved_by->toClientList($Page) ?>;
    loadjs.done("fnpd_confirmdummyedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnpd_confirmdummyedit" id="fnpd_confirmdummyedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fnpd_confirmdummyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_confirmdummyedit", "x_tglterima", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["fnpd_confirmdummyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_confirmdummyedit", "x_tglsubmit", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["fnpd_confirmdummyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_confirmdummyedit", "x_ttd", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<?php } ?>
    ...
    <input type="hidden" data-table="npd_confirmdummy" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<div id="tpd_npd_confirmdummyedit" class="ew-custom-template"></div>
<template id="tpm_npd_confirmdummyedit">
<div id="ct_NpdConfirmdummyEdit"><div class="form-horizontal">
    <div class="card">
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_npd_confirmdummyedit", "tpm_npd_confirmdummyedit", "npd_confirmdummyedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
