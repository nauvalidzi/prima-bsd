...
loadjs.ready("head", function () {
    ...
    fnpd_confirmdummyedit.lists.checked_by = <?= $Page->checked_by->toClientList($Page) ?>;
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_npd_confirmdummy_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
