...
loadjs.ready("head", function () {
    ...
    fkecamatanadd.addFields([
        ...
        ["idkabupaten", [fields.idkabupaten.visible && fields.idkabupaten.required ? ew.Validators.required(fields.idkabupaten.caption) : null, ew.Validators.integer], fields.idkabupaten.isInvalid],
    ...
    fkecamatanadd.lists.idkabupaten = <?= $Page->idkabupaten->toClientList($Page) ?>;
...
<script>
loadjs.ready(["fkecamatanadd"], function() {
    fkecamatanadd.createAutoSuggest(Object.assign({"id":"x_idkabupaten","forceSelect":false}, ew.vars.tables.kecamatan.fields.idkabupaten.autoSuggestOptions));
});
</script>
