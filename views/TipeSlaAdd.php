...
loadjs.ready("head", function () {
    ...
    ftipe_slaadd = currentForm = new ew.Form("ftipe_slaadd", "add");
    ...
    // Validate form
    ftipe_slaadd.validate = function () {
    ...
    // Form_CustomValidate
    ftipe_slaadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftipe_slaadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftipe_slaadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftipe_slaadd" id="ftipe_slaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
