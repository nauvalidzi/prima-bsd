...
// Page object
$VBonuscustomerDetailList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fv_bonuscustomer_detaillist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fv_bonuscustomer_detaillist = currentForm = new ew.Form("fv_bonuscustomer_detaillist", "list");
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> v_bonuscustomer_detail">
<form name="fv_bonuscustomer_detaillist" id="fv_bonuscustomer_detaillist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<table id="tbl_v_bonuscustomer_detaillist" class="table ew-table"><!-- .ew-table -->
<thead>
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_v_bonuscustomer_detail", "data-rowtype" => $Page->RowType]);
...
<span id="el<?= $Page->RowCount ?>_v_bonuscustomer_detail_blackbonus">
