...
// Page object
$NpdBentukSediaanEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fnpd_bentuk_sediaanedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fnpd_bentuk_sediaanedit = currentForm = new ew.Form("fnpd_bentuk_sediaanedit", "edit");
    ...
    fnpd_bentuk_sediaanedit.addFields([
    ...
    // Validate form
    fnpd_bentuk_sediaanedit.validate = function () {
    ...
    // Form_CustomValidate
    fnpd_bentuk_sediaanedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnpd_bentuk_sediaanedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fnpd_bentuk_sediaanedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnpd_bentuk_sediaanedit" id="fnpd_bentuk_sediaanedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="npd_bentuk_sediaan" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
