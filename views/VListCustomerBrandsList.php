...
// Page object
$VListCustomerBrandsList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fv_list_customer_brandslist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fv_list_customer_brandslist = currentForm = new ew.Form("fv_list_customer_brandslist", "list");
    fv_list_customer_brandslist.formKeyCountName = '<?= $Page->FormKeyCountName ?>';
    loadjs.done("fv_list_customer_brandslist");
});
var fv_list_customer_brandslistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    fv_list_customer_brandslistsrch = currentSearchForm = new ew.Form("fv_list_customer_brandslistsrch");

    // Dynamic selection lists

    // Filters
    fv_list_customer_brandslistsrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("fv_list_customer_brandslistsrch");
});
</script>
<style>
...
<form name="fv_list_customer_brandslistsrch" id="fv_list_customer_brandslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="fv_list_customer_brandslistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> v_list_customer_brands">
<form name="fv_list_customer_brandslist" id="fv_list_customer_brandslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<table id="tbl_v_list_customer_brandslist" class="table ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->nama_brand->Visible) { // nama_brand ?>
        <th data-name="nama_brand" class="<?= $Page->nama_brand->headerCellClass() ?>"><div id="elh_v_list_customer_brands_nama_brand" class="v_list_customer_brands_nama_brand"><?= $Page->renderSort($Page->nama_brand) ?></div></th>
<?php } ?>
<?php if ($Page->jumlah_produk->Visible) { // jumlah_produk ?>
        <th data-name="jumlah_produk" class="<?= $Page->jumlah_produk->headerCellClass() ?>"><div id="elh_v_list_customer_brands_jumlah_produk" class="v_list_customer_brands_jumlah_produk"><?= $Page->renderSort($Page->jumlah_produk) ?></div></th>
<?php } ?>
<?php
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_v_list_customer_brands", "data-rowtype" => $Page->RowType]);
...
<span id="el<?= $Page->RowCount ?>_v_list_customer_brands_nama_brand">
...
<span id="el<?= $Page->RowCount ?>_v_list_customer_brands_jumlah_produk">
