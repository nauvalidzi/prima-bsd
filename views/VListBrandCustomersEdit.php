...
// Page object
$VListBrandCustomersEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fv_list_brand_customersedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fv_list_brand_customersedit = currentForm = new ew.Form("fv_list_brand_customersedit", "edit");
    ...
    fv_list_brand_customersedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fv_list_brand_customersedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fv_list_brand_customersedit.validate = function () {
    ...
    // Form_CustomValidate
    fv_list_brand_customersedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fv_list_brand_customersedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fv_list_brand_customersedit.lists.idbrand = <?= $Page->idbrand->toClientList($Page) ?>;
    fv_list_brand_customersedit.lists.idcustomer = <?= $Page->idcustomer->toClientList($Page) ?>;
    loadjs.done("fv_list_brand_customersedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fv_list_brand_customersedit" id="fv_list_brand_customersedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
