...
<div id="tpd_ijinbpomedit" class="ew-custom-template"></div>
<template id="tpm_ijinbpomedit">
<div id="ct_IjinbpomEdit"><div class="form-horizontal">
    <div class="card">
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ijinbpomedit", "tpm_ijinbpomedit", "ijinbpomedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
