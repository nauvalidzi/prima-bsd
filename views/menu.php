...
$sideMenu->addMenuItem(592, "mi_laporan_kpi_sales", $MenuLanguage->MenuPhrase("592", "MenuText"), $MenuRelativePath . "LaporanKpiSales", 547, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}laporan_kpi_sales.php'), false, false, "far fa-circle", "", false);
...
$sideMenu->addMenuItem(591, "mi_kpi_marketing", $MenuLanguage->MenuPhrase("591", "MenuText"), $MenuRelativePath . "KpiMarketingList", -1, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}kpi_marketing'), false, false, "fas fa-funnel-dollar", "", false);
...
$sideMenu->addMenuItem(11, "mi_kategoribarang", $MenuLanguage->MenuPhrase("11", "MenuText"), $MenuRelativePath . "KategoribarangList", 403, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}kategoribarang'), false, false, "far a-circle", "", false);
