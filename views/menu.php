...
$sideMenu->addMenuItem(805, "mi_npd_serahterima", $MenuLanguage->MenuPhrase("805", "MenuText"), $MenuRelativePath . "NpdSerahterimaList", 469, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}npd_serahterima'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(408, "mi_npd_sample", $MenuLanguage->MenuPhrase("408", "MenuText"), $MenuRelativePath . "NpdSampleList?cmd=resetall", 469, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}npd_sample'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(404, "mi_npd_review", $MenuLanguage->MenuPhrase("404", "MenuText"), $MenuRelativePath . "NpdReviewList?cmd=resetall", 469, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}npd_review'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(470, "mi_npd_confirm", $MenuLanguage->MenuPhrase("470", "MenuText"), $MenuRelativePath . "NpdConfirmList?cmd=resetall", 469, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}npd_confirm'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(409, "mi_serahterima", $MenuLanguage->MenuPhrase("409", "MenuText"), $MenuRelativePath . "SerahterimaList", 469, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}serahterima'), false, false, "far fa-circle", "", false);
