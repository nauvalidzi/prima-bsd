...
$sideMenu->addMenuItem(470, "mi_npd_confirmsample", $MenuLanguage->MenuPhrase("470", "MenuText"), $MenuRelativePath . "NpdConfirmsampleList?cmd=resetall", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}npd_confirmsample'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(406, "mi_npd_harga", $MenuLanguage->MenuPhrase("406", "MenuText"), $MenuRelativePath . "NpdHargaList?cmd=resetall", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}npd_harga'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(283, "mi_ijinhaki", $MenuLanguage->MenuPhrase("283", "MenuText"), $MenuRelativePath . "IjinhakiList", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}ijinhaki'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(306, "mi_ijinbpom", $MenuLanguage->MenuPhrase("306", "MenuText"), $MenuRelativePath . "IjinbpomList", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}ijinbpom'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(804, "mi_npd_desain", $MenuLanguage->MenuPhrase("804", "MenuText"), $MenuRelativePath . "NpdDesainList?cmd=resetall", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}npd_desain'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(1067, "mi_npd_confirmdesign", $MenuLanguage->MenuPhrase("1067", "MenuText"), $MenuRelativePath . "NpdConfirmdesignList", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}npd_confirmdesign'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(1069, "mi_npd_confirmdummy", $MenuLanguage->MenuPhrase("1069", "MenuText"), $MenuRelativePath . "NpdConfirmdummyList", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}npd_confirmdummy'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(1068, "mi_npd_confirmprint", $MenuLanguage->MenuPhrase("1068", "MenuText"), $MenuRelativePath . "NpdConfirmprintList", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}npd_confirmprint'), false, false, "far fa-circle", "", false);
...
$sideMenu->addMenuItem(1070, "mi_npd_resume", $MenuLanguage->MenuPhrase("1070", "MenuText"), $MenuRelativePath . "NpdResume", 469, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}npd_resume.php'), false, false, "fas fa-clipboard", "", false);
...
$sideMenu->addMenuItem(1065, "mi_v_kartu_stok", $MenuLanguage->MenuPhrase("1065", "MenuText"), $MenuRelativePath . "VKartuStokList", 918, "", AllowListMenu('{B32B7005-E649-463B-AEE9-0CDA6C0094D3}v_kartu_stok'), false, false, "fas fa-warehouse", "", false);
