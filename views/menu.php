...
$sideMenu->addMenuItem(474, "mi_d_jatuhtempo", $MenuLanguage->MenuPhrase("474", "MenuText"), $MenuRelativePath . "DJatuhtempoList", 571, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}d_jatuhtempo'), false, false, "", "", false);
...
$sideMenu->addMenuItem(343, "mi_v_orderdetail", $MenuLanguage->MenuPhrase("343", "MenuText"), $MenuRelativePath . "VOrderdetailList", 50, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}v_orderdetail'), false, false, "", "", false);
...
$sideMenu->addMenuItem(477, "mi_v_bonuscustomer_detail", $MenuLanguage->MenuPhrase("477", "MenuText"), $MenuRelativePath . "VBonuscustomerDetailList?cmd=resetall", 50, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}v_bonuscustomer_detail'), false, false, "", "", false);
...
$sideMenu->addMenuItem(349, "mi_v_piutang_detail", $MenuLanguage->MenuPhrase("349", "MenuText"), $MenuRelativePath . "VPiutangDetailList?cmd=resetall", 49, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}v_piutang_detail'), false, false, "", "", false);
