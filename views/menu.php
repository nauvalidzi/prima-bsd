...
$sideMenu->addMenuItem(695, "mci_Penagihan_Customer", $MenuLanguage->MenuPhrase("695", "MenuText"), "", -1, "", true, false, true, "fas fa-file-invoice-dollar", "", false);
$sideMenu->addMenuItem(602, "mi_penagihan_customer", $MenuLanguage->MenuPhrase("602", "MenuText"), $MenuRelativePath . "PenagihanCustomer", 695, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}penagihan_customer.php'), false, false, "far fa-circle", "", false);
$sideMenu->addMenuItem(696, "mi_penagihan", $MenuLanguage->MenuPhrase("696", "MenuText"), $MenuRelativePath . "PenagihanList", 695, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}penagihan'), false, false, "far fa-circle", "", false);
...
$sideMenu->addMenuItem(595, "mi_penomoran", $MenuLanguage->MenuPhrase("595", "MenuText"), $MenuRelativePath . "PenomoranList", 570, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}penomoran'), false, false, "far fa-circle", "", false);
