...
$sideMenu->addMenuItem(923, "mi_pengembangan_produk", $MenuLanguage->MenuPhrase("923", "MenuText"), $MenuRelativePath . "PengembanganProduk", -1, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}pengembangan_produk.php'), false, false, "fa-dice", "", false);
...
$sideMenu->addMenuItem(808, "mi_stocks", $MenuLanguage->MenuPhrase("808", "MenuText"), $MenuRelativePath . "StocksList", -1, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}stocks'), false, false, "fa-database", "", false);
...
$sideMenu->addMenuItem(347, "mi_npd", $MenuLanguage->MenuPhrase("347", "MenuText"), $MenuRelativePath . "NpdList", 570, "", AllowListMenu('{4FA0DF52-C852-4B9E-ABFE-6BF1F23D959B}npd'), false, false, "far fa-circle", "", false);
