...
<?php if ($Page->idorder->Visible) { // idorder ?>
        <th data-name="idorder" class="<?= $Page->idorder->headerCellClass() ?>"><div id="elh_po_limit_approval_idorder" class="po_limit_approval_idorder"><?= $Page->renderSort($Page->idorder) ?></div></th>
<?php } ?>
...
<?php if ($Page->updated_at->Visible) { // updated_at ?>
        <th data-name="updated_at" class="<?= $Page->updated_at->headerCellClass() ?>"><div id="elh_po_limit_approval_updated_at" class="po_limit_approval_updated_at"><?= $Page->renderSort($Page->updated_at) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_po_limit_approval_idorder">
...
<span id="el<?= $Page->RowCount ?>_po_limit_approval_updated_at">
