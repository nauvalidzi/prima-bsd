...
// Page object
$NpdMasterSpesifikasiAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fnpd_master_spesifikasiadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fnpd_master_spesifikasiadd = currentForm = new ew.Form("fnpd_master_spesifikasiadd", "add");
    ...
    fnpd_master_spesifikasiadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fnpd_master_spesifikasiadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fnpd_master_spesifikasiadd.validate = function () {
    ...
    // Form_CustomValidate
    fnpd_master_spesifikasiadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnpd_master_spesifikasiadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fnpd_master_spesifikasiadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnpd_master_spesifikasiadd" id="fnpd_master_spesifikasiadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fnpd_master_spesifikasiadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_master_spesifikasiadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
