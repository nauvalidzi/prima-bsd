...
// Page object
$VBrandCustomerList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fv_brand_customerlist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fv_brand_customerlist = currentForm = new ew.Form("fv_brand_customerlist", "list");
    fv_brand_customerlist.formKeyCountName = '<?= $Page->FormKeyCountName ?>';
    loadjs.done("fv_brand_customerlist");
});
var fv_brand_customerlistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    fv_brand_customerlistsrch = currentSearchForm = new ew.Form("fv_brand_customerlistsrch");

    // Dynamic selection lists

    // Filters
    fv_brand_customerlistsrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("fv_brand_customerlistsrch");
});
</script>
<style>
...
<form name="fv_brand_customerlistsrch" id="fv_brand_customerlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="fv_brand_customerlistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
<input type="hidden" name="cmd" value="search">
<input type="hidden" name="t" value="v_brand_customer">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> v_brand_customer">
<form name="fv_brand_customerlist" id="fv_brand_customerlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<table id="tbl_v_brand_customerlist" class="table ew-table"><!-- .ew-table -->
<thead>
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_v_brand_customer", "data-rowtype" => $Page->RowType]);
...
<span id="el<?= $Page->RowCount ?>_v_brand_customer_idbrand">
