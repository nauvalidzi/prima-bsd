...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_npd_serahterima_id" class="npd_serahterima_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_npd_serahterima_id">
