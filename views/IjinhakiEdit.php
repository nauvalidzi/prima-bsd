...
loadjs.ready("head", function () {
    ...
    fijinhakiedit.lists.idnpd = <?= $Page->idnpd->toClientList($Page) ?>;
    fijinhakiedit.lists.submitted_by = <?= $Page->submitted_by->toClientList($Page) ?>;
    fijinhakiedit.lists.checked1_by = <?= $Page->checked1_by->toClientList($Page) ?>;
    fijinhakiedit.lists.checked2_by = <?= $Page->checked2_by->toClientList($Page) ?>;
    fijinhakiedit.lists.approved_by = <?= $Page->approved_by->toClientList($Page) ?>;
...
<script>
loadjs.ready(["fijinhakiedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fijinhakiedit", "x_tglterima", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["fijinhakiedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fijinhakiedit", "x_tglsubmit", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<input type="hidden" name="fa_x_akta_pendirian" id= "fa_x_akta_pendirian" value="<?= (Post("fa_x_akta_pendirian") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_ttd_pemohon" id= "fa_x_ttd_pemohon" value="<?= (Post("fa_x_ttd_pemohon") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_label_brand" id= "fa_x_label_brand" value="<?= (Post("fa_x_label_brand") == "0") ? "0" : "1" ?>">
...
<?php if ($Page->selesai->Visible) { // selesai ?>
    <div id="r_selesai" class="form-group row">
        <label id="elh_ijinhaki_selesai" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ijinhaki_selesai"><?= $Page->selesai->caption() ?><?= $Page->selesai->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<div id="tpd_ijinhakiedit" class="ew-custom-template"></div>
<template id="tpm_ijinhakiedit">
<div id="ct_IjinhakiEdit"><div class="form-horizontal">
    <div class="card">
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ijinhakiedit", "tpm_ijinhakiedit", "ijinhakiedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
