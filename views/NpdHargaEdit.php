...
loadjs.ready("head", function () {
    ...
    fnpd_hargaedit.lists.viskositas = <?= $Page->viskositas->toClientList($Page) ?>;
    fnpd_hargaedit.lists.warna = <?= $Page->warna->toClientList($Page) ?>;
    fnpd_hargaedit.lists.aplikasisediaan = <?= $Page->aplikasisediaan->toClientList($Page) ?>;
    fnpd_hargaedit.lists.segel = <?= $Page->segel->toClientList($Page) ?>;
    fnpd_hargaedit.lists.jenislabel = <?= $Page->jenislabel->toClientList($Page) ?>;
    fnpd_hargaedit.lists.kualitaslabel = <?= $Page->kualitaslabel->toClientList($Page) ?>;
    fnpd_hargaedit.lists.kategoridelivery = <?= $Page->kategoridelivery->toClientList($Page) ?>;
...
<script>
loadjs.ready(["fnpd_hargaedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_hargaedit", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<div id="tpd_npd_hargaedit" class="ew-custom-template"></div>
<template id="tpm_npd_hargaedit">
<div id="ct_NpdHargaEdit"><div class="form-horizontal">
    <div class="card">
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_npd_hargaedit", "tpm_npd_hargaedit", "npd_hargaedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
