...
// Page object
$ViskositasbarangAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fviskositasbarangadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fviskositasbarangadd = currentForm = new ew.Form("fviskositasbarangadd", "add");
    ...
    // Validate form
    fviskositasbarangadd.validate = function () {
    ...
    // Form_CustomValidate
    fviskositasbarangadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fviskositasbarangadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fviskositasbarangadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fviskositasbarangadd" id="fviskositasbarangadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
