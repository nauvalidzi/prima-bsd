...
// Page object
$IjinhakiStatusEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fijinhaki_statusedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fijinhaki_statusedit = currentForm = new ew.Form("fijinhaki_statusedit", "edit");
    ...
    fijinhaki_statusedit.addFields([
    ...
    // Validate form
    fijinhaki_statusedit.validate = function () {
    ...
    // Form_CustomValidate
    fijinhaki_statusedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fijinhaki_statusedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fijinhaki_statusedit.lists.idpegawai = <?= $Page->idpegawai->toClientList($Page) ?>;
    loadjs.done("fijinhaki_statusedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fijinhaki_statusedit" id="fijinhaki_statusedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fijinhaki_statusedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fijinhaki_statusedit", "x_targetmulai", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fijinhaki_statusedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fijinhaki_statusedit", "x_tglmulai", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fijinhaki_statusedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fijinhaki_statusedit", "x_targetselesai", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fijinhaki_statusedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fijinhaki_statusedit", "x_tglselesai", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php } ?>
    ...
    <input type="hidden" data-table="ijinhaki_status" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
