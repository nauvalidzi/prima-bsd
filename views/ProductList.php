...
<form name="fproductlistsrch" id="fproductlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php if ($Page->idbrand->Visible) { // idbrand ?>
        <th data-name="idbrand" class="<?= $Page->idbrand->headerCellClass() ?>"><div id="elh_product_idbrand" class="product_idbrand"><?= $Page->renderSort($Page->idbrand) ?></div></th>
<?php } ?>
<?php if ($Page->kode->Visible) { // kode ?>
        <th data-name="kode" class="<?= $Page->kode->headerCellClass() ?>"><div id="elh_product_kode" class="product_kode"><?= $Page->renderSort($Page->kode) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_product_idbrand">
...
<span id="el<?= $Page->RowCount ?>_product_kode">
...
<span id="el<?= $Page->RowCount ?>_product_nama">
