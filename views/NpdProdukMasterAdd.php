...
// Page object
$NpdProdukMasterAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fnpd_produk_masteradd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fnpd_produk_masteradd = currentForm = new ew.Form("fnpd_produk_masteradd", "add");
    ...
    fnpd_produk_masteradd.addFields([
    ...
    // Validate form
    fnpd_produk_masteradd.validate = function () {
    ...
    // Form_CustomValidate
    fnpd_produk_masteradd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnpd_produk_masteradd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fnpd_produk_masteradd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnpd_produk_masteradd" id="fnpd_produk_masteradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fnpd_produk_masteradd", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_produk_masteradd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
