...
<script>
loadjs.ready(["finvoiceedit"], function() {
    finvoiceedit.createAutoSuggest(Object.assign({"id":"x_idtermpayment","forceSelect":false}, ew.vars.tables.invoice.fields.idtermpayment.autoSuggestOptions));
});
</script>
...
loadjs.ready("load", function () {
    // Startup script
    loadjs.ready("jquery",(function(){$("#x_pajak").change((function(){var a=parseInt($("#x_totalnonpajak").val())||0,n=a+(parseFloat($("#x_pajak").val())||0)/100*a;$("#x_totaltagihan").val(n).change()}))}));
});
</script>
