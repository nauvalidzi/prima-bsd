...
?>
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "product") {
    if ($Page->MasterRecordExists) {
        include_once "views/ProductMaster.php";
    }
}
?>
<?php } ?>
...
<?php } ?>
<?php if ($Page->getCurrentMasterTable() == "product" && $Page->CurrentAction) { ?>
