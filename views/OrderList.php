...
loadjs.ready("head", function () {
    ...
    forderlist = currentForm = new ew.Form("forderlist", "list");
    forderlist.formKeyCountName = '<?= $Page->FormKeyCountName ?>';
    loadjs.done("forderlist");
});
var forderlistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    forderlistsrch = currentSearchForm = new ew.Form("forderlistsrch");

    // Dynamic selection lists

    // Filters
    forderlistsrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("forderlistsrch");
});
</script>
<style>
...
<form name="forderlistsrch" id="forderlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="forderlistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> order">
<form name="forderlist" id="forderlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->kode->Visible) { // kode ?>
        <th data-name="kode" class="<?= $Page->kode->headerCellClass() ?>"><div id="elh_order_kode" class="order_kode"><?= $Page->renderSort($Page->kode) ?></div></th>
<?php } ?>
<?php if ($Page->tanggal->Visible) { // tanggal ?>
        <th data-name="tanggal" class="<?= $Page->tanggal->headerCellClass() ?>"><div id="elh_order_tanggal" class="order_tanggal"><?= $Page->renderSort($Page->tanggal) ?></div></th>
<?php } ?>
<?php if ($Page->idpegawai->Visible) { // idpegawai ?>
        <th data-name="idpegawai" class="<?= $Page->idpegawai->headerCellClass() ?>"><div id="elh_order_idpegawai" class="order_idpegawai"><?= $Page->renderSort($Page->idpegawai) ?></div></th>
<?php } ?>
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_order", "data-rowtype" => $Page->RowType]);
...
<span id="el<?= $Page->RowCount ?>_order_kode">
...
<span id="el<?= $Page->RowCount ?>_order_tanggal">
...
<span id="el<?= $Page->RowCount ?>_order_idpegawai">
...
<span id="el<?= $Page->RowCount ?>_order_idcustomer">
