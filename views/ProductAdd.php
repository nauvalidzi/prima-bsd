...
loadjs.ready("head", function () {
    ...
    fproductadd.lists.idbrand = <?= $Page->idbrand->toClientList($Page) ?>;
    fproductadd.lists.idkategoribarang = <?= $Page->idkategoribarang->toClientList($Page) ?>;
    fproductadd.lists.idjenisbarang = <?= $Page->idjenisbarang->toClientList($Page) ?>;
    fproductadd.lists.idkualitasbarang = <?= $Page->idkualitasbarang->toClientList($Page) ?>;
    fproductadd.lists.idproduct_acuan = <?= $Page->idproduct_acuan->toClientList($Page) ?>;
    fproductadd.lists.ijinbpom = <?= $Page->ijinbpom->toClientList($Page) ?>;
    fproductadd.lists.aktif = <?= $Page->aktif->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fproductadd" id="fproductadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_product_id" for="x_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_product_id">
<input type="<?= $Page->id->getInputTextType() ?>" data-table="product" data-field="x_id" name="x_id" id="x_id" placeholder="<?= HtmlEncode($Page->id->getPlaceHolder()) ?>" value="<?= $Page->id->EditValue ?>"<?= $Page->id->editAttributes() ?> aria-describedby="x_id_help">
