...
loadjs.ready("head", function () {
    ...
    frekeningadd = currentForm = new ew.Form("frekeningadd", "add");
    ...
    // Validate form
    frekeningadd.validate = function () {
    ...
    // Form_CustomValidate
    frekeningadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frekeningadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("frekeningadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frekeningadd" id="frekeningadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
