...
<?php if ($Page->kode->Visible) { // kode ?>
        <th data-name="kode" class="<?= $Page->kode->headerCellClass() ?>"><div id="elh_pegawai_kode" class="pegawai_kode"><?= $Page->renderSort($Page->kode) ?></div></th>
<?php } ?>
<?php if ($Page->nama->Visible) { // nama ?>
        <th data-name="nama" class="<?= $Page->nama->headerCellClass() ?>"><div id="elh_pegawai_nama" class="pegawai_nama"><?= $Page->renderSort($Page->nama) ?></div></th>
<?php } ?>
<?php if ($Page->wa->Visible) { // wa ?>
        <th data-name="wa" class="<?= $Page->wa->headerCellClass() ?>"><div id="elh_pegawai_wa" class="pegawai_wa"><?= $Page->renderSort($Page->wa) ?></div></th>
<?php } ?>
<?php if ($Page->hp->Visible) { // hp ?>
        <th data-name="hp" class="<?= $Page->hp->headerCellClass() ?>"><div id="elh_pegawai_hp" class="pegawai_hp"><?= $Page->renderSort($Page->hp) ?></div></th>
<?php } ?>
<?php if ($Page->rekbank->Visible) { // rekbank ?>
        <th data-name="rekbank" class="<?= $Page->rekbank->headerCellClass() ?>"><div id="elh_pegawai_rekbank" class="pegawai_rekbank"><?= $Page->renderSort($Page->rekbank) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_pegawai_kode">
...
<span id="el<?= $Page->RowCount ?>_pegawai_nama">
...
<span id="el<?= $Page->RowCount ?>_pegawai_wa">
...
<span id="el<?= $Page->RowCount ?>_pegawai_hp">
...
<span id="el<?= $Page->RowCount ?>_pegawai_rekbank">
