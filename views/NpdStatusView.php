...
loadjs.ready("head", function () {
    ...
    fnpd_statusview = currentForm = new ew.Form("fnpd_statusview", "view");
    loadjs.done("fnpd_statusview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnpd_statusview" id="fnpd_statusview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->idpegawai->Visible) { // idpegawai ?>
    <tr id="r_idpegawai">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_status_idpegawai"><?= $Page->idpegawai->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_status_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->targetmulai->Visible) { // targetmulai ?>
    <tr id="r_targetmulai">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_status_targetmulai"><?= $Page->targetmulai->caption() ?></span></td>
...
<?php if ($Page->tglmulai->Visible) { // tglmulai ?>
    <tr id="r_tglmulai">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_status_tglmulai"><?= $Page->tglmulai->caption() ?></span></td>
...
<?php if ($Page->targetselesai->Visible) { // targetselesai ?>
    <tr id="r_targetselesai">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_status_targetselesai"><?= $Page->targetselesai->caption() ?></span></td>
...
<?php if ($Page->tglselesai->Visible) { // tglselesai ?>
    <tr id="r_tglselesai">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_status_tglselesai"><?= $Page->tglselesai->caption() ?></span></td>
...
<?php if ($Page->keterangan->Visible) { // keterangan ?>
    <tr id="r_keterangan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_status_keterangan"><?= $Page->keterangan->caption() ?></span></td>
...
<?php if ($Page->lampiran->Visible) { // lampiran ?>
    <tr id="r_lampiran">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_npd_status_lampiran"><?= $Page->lampiran->caption() ?></span></td>
