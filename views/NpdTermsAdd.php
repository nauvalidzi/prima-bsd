...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->sifat_order->isInvalidClass() ?>" data-table="npd_terms" data-field="x_sifat_order" name="x_sifat_order[]" id="x_sifat_order_741007" value="1"<?= ConvertToBool($Page->sifat_order->CurrentValue) ? " checked" : "" ?><?= $Page->sifat_order->editAttributes() ?> aria-describedby="x_sifat_order_help">
    <label class="custom-control-label" for="x_sifat_order_741007"></label>
</div>
