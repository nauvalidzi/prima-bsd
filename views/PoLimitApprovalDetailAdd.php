...
// Page object
$PoLimitApprovalDetailAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpo_limit_approval_detailadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpo_limit_approval_detailadd = currentForm = new ew.Form("fpo_limit_approval_detailadd", "add");
    ...
    fpo_limit_approval_detailadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpo_limit_approval_detailadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fpo_limit_approval_detailadd.validate = function () {
    ...
    // Form_CustomValidate
    fpo_limit_approval_detailadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpo_limit_approval_detailadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpo_limit_approval_detailadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpo_limit_approval_detailadd" id="fpo_limit_approval_detailadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpo_limit_approval_detailadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpo_limit_approval_detailadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
