...
<input type="hidden" name="fa_x_ktp" id= "fa_x_ktp" value="0">
...
<input type="hidden" name="fa_x_npwp" id= "fa_x_npwp" value="0">
...
<?php } ?>
    <span id="el_customer_created_by">
    <input type="hidden" data-table="customer" data-field="x_created_by" data-hidden="1" name="x_created_by" id="x_created_by" value="<?= HtmlEncode($Page->created_by->CurrentValue) ?>">
    </span>
</div><!-- /page* -->
...
?>
<?php
    if (in_array("brand", explode(",", $Page->getCurrentDetailTable())) && $brand->DetailAdd) {
