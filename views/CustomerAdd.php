...
<script>
loadjs.ready(["fcustomeradd"], function() {
    fcustomeradd.createAutoSuggest(Object.assign({"id":"x_idprov","forceSelect":false}, ew.vars.tables.customer.fields.idprov.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fcustomeradd"], function() {
    fcustomeradd.createAutoSuggest(Object.assign({"id":"x_idkab","forceSelect":false}, ew.vars.tables.customer.fields.idkab.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fcustomeradd"], function() {
    fcustomeradd.createAutoSuggest(Object.assign({"id":"x_idkec","forceSelect":false}, ew.vars.tables.customer.fields.idkec.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fcustomeradd"], function() {
    fcustomeradd.createAutoSuggest(Object.assign({"id":"x_idkel","forceSelect":false}, ew.vars.tables.customer.fields.idkel.autoSuggestOptions));
});
</script>
