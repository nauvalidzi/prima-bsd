...
<?php if ($Page->tanggal->Visible) { // tanggal ?>
        <th data-name="tanggal" class="<?= $Page->tanggal->headerCellClass() ?>"><div id="elh_bot_history_tanggal" class="bot_history_tanggal"><?= $Page->renderSort($Page->tanggal) ?></div></th>
<?php } ?>
...
<?php if ($Page->created_by->Visible) { // created_by ?>
        <th data-name="created_by" class="<?= $Page->created_by->headerCellClass() ?>"><div id="elh_bot_history_created_by" class="bot_history_created_by"><?= $Page->renderSort($Page->created_by) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_bot_history_tanggal">
...
<span id="el<?= $Page->RowCount ?>_bot_history_created_by">
