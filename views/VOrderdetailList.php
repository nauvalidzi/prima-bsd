...
// Page object
$VOrderdetailList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fv_orderdetaillist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fv_orderdetaillist = currentForm = new ew.Form("fv_orderdetaillist", "list");
    fv_orderdetaillist.formKeyCountName = '<?= $Page->FormKeyCountName ?>';
    loadjs.done("fv_orderdetaillist");
});
var fv_orderdetaillistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    fv_orderdetaillistsrch = currentSearchForm = new ew.Form("fv_orderdetaillistsrch");

    // Dynamic selection lists

    // Filters
    fv_orderdetaillistsrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("fv_orderdetaillistsrch");
});
</script>
<style>
...
<form name="fv_orderdetaillistsrch" id="fv_orderdetaillistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="fv_orderdetaillistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> v_orderdetail">
<form name="fv_orderdetaillist" id="fv_orderdetaillist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="v_orderdetail">
<div id="gmp_v_orderdetail" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit()) { ?>
<table id="tbl_v_orderdetaillist" class="table ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_v_orderdetail_id" class="v_orderdetail_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->nama->Visible) { // nama ?>
        <th data-name="nama" class="<?= $Page->nama->headerCellClass() ?>"><div id="elh_v_orderdetail_nama" class="v_orderdetail_nama"><?= $Page->renderSort($Page->nama) ?></div></th>
<?php } ?>
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_v_orderdetail", "data-rowtype" => $Page->RowType]);
...
<span id="el<?= $Page->RowCount ?>_v_orderdetail_id">
...
<span id="el<?= $Page->RowCount ?>_v_orderdetail_nama">
...
<span id="el<?= $Page->RowCount ?>_v_orderdetail_idorder">
...
<span id="el<?= $Page->RowCount ?>_v_orderdetail_aktif">
...
loadjs.ready("head", function() {
    ew.addEventHandlers("v_orderdetail");
});
</script>
<script>
