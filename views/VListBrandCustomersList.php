...
// Page object
$VListBrandCustomersList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fv_list_brand_customerslist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fv_list_brand_customerslist = currentForm = new ew.Form("fv_list_brand_customerslist", "list");
    fv_list_brand_customerslist.formKeyCountName = '<?= $Page->FormKeyCountName ?>';
    loadjs.done("fv_list_brand_customerslist");
});
var fv_list_brand_customerslistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    fv_list_brand_customerslistsrch = currentSearchForm = new ew.Form("fv_list_brand_customerslistsrch");

    // Dynamic selection lists

    // Filters
    fv_list_brand_customerslistsrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("fv_list_brand_customerslistsrch");
});
</script>
<style>
...
<form name="fv_list_brand_customerslistsrch" id="fv_list_brand_customerslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="fv_list_brand_customerslistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> v_list_brand_customers">
<form name="fv_list_brand_customerslist" id="fv_list_brand_customerslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<table id="tbl_v_list_brand_customerslist" class="table ew-table"><!-- .ew-table -->
<thead>
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_v_list_brand_customers", "data-rowtype" => $Page->RowType]);
