...
loadjs.ready("head", function () {
    ...
    fnpd_reviewedit.lists.bentukok = <?= $Page->bentukok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.viskositasok = <?= $Page->viskositasok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.jeniswarnaok = <?= $Page->jeniswarnaok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.tonewarnaok = <?= $Page->tonewarnaok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.gradasiwarnaok = <?= $Page->gradasiwarnaok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.bauok = <?= $Page->bauok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.estetikaok = <?= $Page->estetikaok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.aplikasiawalok = <?= $Page->aplikasiawalok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.aplikasilamaok = <?= $Page->aplikasilamaok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.efekpositifok = <?= $Page->efekpositifok->toClientList($Page) ?>;
    fnpd_reviewedit.lists.efeknegatifok = <?= $Page->efeknegatifok->toClientList($Page) ?>;
...
loadjs.ready(["fnpd_reviewedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_reviewedit", "x_tglreview", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fnpd_reviewedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_reviewedit", "x_tglsubmit", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
