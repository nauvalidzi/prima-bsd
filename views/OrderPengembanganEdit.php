...
// Page object
$OrderPengembanganEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var forder_pengembanganedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    forder_pengembanganedit = currentForm = new ew.Form("forder_pengembanganedit", "edit");
    ...
    forder_pengembanganedit.addFields([
    ...
    // Validate form
    forder_pengembanganedit.validate = function () {
    ...
    // Form_CustomValidate
    forder_pengembanganedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    forder_pengembanganedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("forder_pengembanganedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="forder_pengembanganedit" id="forder_pengembanganedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="order_pengembangan" data-field="x_id" data-hidden="1" name="o_id" id="o_id" value="<?= HtmlEncode($Page->id->OldValue ?? $Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_orderterimatgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_ordertgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_createat", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_update_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_aju_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_proses_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_revisi_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_revisi_akun_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_revisi_rnd_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_rnd_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_ap_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["forder_pengembanganedit", "datetimepicker"], function() {
    ew.createDateTimePicker("forder_pengembanganedit", "x_batal_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<div id="tpd_order_pengembanganedit" class="ew-custom-template"></div>
<template id="tpm_order_pengembanganedit">
<div id="ct_OrderPengembanganEdit"><?php include_once "custom_views/order_sampel.php" ?>
</div>
</template>
<?php if (!$Page->IsModal) { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_order_pengembanganedit", "tpm_order_pengembanganedit", "order_pengembanganedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
