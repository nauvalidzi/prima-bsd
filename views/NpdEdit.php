...
<textarea data-table="npd" data-field="x_kemasanbarang" name="x_kemasanbarang" id="x_kemasanbarang" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->kemasanbarang->getPlaceHolder()) ?>"<?= $Page->kemasanbarang->editAttributes() ?> aria-describedby="x_kemasanbarang_help"><?= $Page->kemasanbarang->EditValue ?></textarea>
...
<textarea data-table="npd" data-field="x_label" name="x_label" id="x_label" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->label->getPlaceHolder()) ?>"<?= $Page->label->editAttributes() ?> aria-describedby="x_label_help"><?= $Page->label->EditValue ?></textarea>
...
<input type="<?= $Page->kategori->getInputTextType() ?>" data-table="npd" data-field="x_kategori" name="x_kategori" id="x_kategori" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->kategori->getPlaceHolder()) ?>" value="<?= $Page->kategori->EditValue ?>"<?= $Page->kategori->editAttributes() ?> aria-describedby="x_kategori_help">
