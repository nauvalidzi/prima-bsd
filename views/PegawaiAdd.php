...
loadjs.ready("head", function () {
    ...
    fpegawaiadd.lists.wa = <?= $Page->wa->toClientList($Page) ?>;
...
loadjs.ready(["fpegawaiadd"], function() {
    fpegawaiadd.createAutoSuggest(Object.assign({"id":"x_wa","forceSelect":false}, ew.vars.tables.pegawai.fields.wa.autoSuggestOptions));
});
</script>
