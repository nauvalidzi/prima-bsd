...
loadjs.ready(["fnpd_confirmdesignedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_confirmdesignedit", "x_tglterima", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<script>
loadjs.ready(["fnpd_confirmdesignedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fnpd_confirmdesignedit", "x_tglsubmit", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span></template>
...
<div id="tpd_npd_confirmdesignedit" class="ew-custom-template"></div>
<template id="tpm_npd_confirmdesignedit">
<div id="ct_NpdConfirmdesignEdit"><div class="form-horizontal">
    <div class="card">
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_npd_confirmdesignedit", "tpm_npd_confirmdesignedit", "npd_confirmdesignedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
