...
loadjs.ready("head", function () {
    ...
    fkelurahanedit = currentForm = new ew.Form("fkelurahanedit", "edit");
    ...
    // Validate form
    fkelurahanedit.validate = function () {
    ...
    // Form_CustomValidate
    fkelurahanedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkelurahanedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fkelurahanedit.lists.idkecamatan = <?= $Page->idkecamatan->toClientList($Page) ?>;
    loadjs.done("fkelurahanedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkelurahanedit" id="fkelurahanedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fkelurahanedit"], function() {
    fkelurahanedit.createAutoSuggest(Object.assign({"id":"x_idkecamatan","forceSelect":false}, ew.vars.tables.kelurahan.fields.idkecamatan.autoSuggestOptions));
});
</script>
