...
// Page object
$JenisbarangList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fjenisbaranglist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fjenisbaranglist = currentForm = new ew.Form("fjenisbaranglist", "list");
    fjenisbaranglist.formKeyCountName = '<?= $Page->FormKeyCountName ?>';
    loadjs.done("fjenisbaranglist");
});
var fjenisbaranglistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    ...
    // Filters
    fjenisbaranglistsrch.filterList = <?= $Page->getFilterList() ?>;
...
<form name="fjenisbaranglistsrch" id="fjenisbaranglistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="fjenisbaranglistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> jenisbarang">
<form name="fjenisbaranglist" id="fjenisbaranglist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="jenisbarang">
<div id="gmp_jenisbarang" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_jenisbarang", "data-rowtype" => $Page->RowType]);
