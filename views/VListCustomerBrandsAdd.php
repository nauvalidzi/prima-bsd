...
// Page object
$VListCustomerBrandsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fv_list_customer_brandsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fv_list_customer_brandsadd = currentForm = new ew.Form("fv_list_customer_brandsadd", "add");
    ...
    // Set invalid fields
    $(function() {
        var f = fv_list_customer_brandsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fv_list_customer_brandsadd.validate = function () {
    ...
    // Form_CustomValidate
    fv_list_customer_brandsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fv_list_customer_brandsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fv_list_customer_brandsadd.lists.idcustomer = <?= $Page->idcustomer->toClientList($Page) ?>;
    fv_list_customer_brandsadd.lists.idbrand = <?= $Page->idbrand->toClientList($Page) ?>;
    loadjs.done("fv_list_customer_brandsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fv_list_customer_brandsadd" id="fv_list_customer_brandsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
