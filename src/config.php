...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'DqGXysDF1Hqz6sfz', // Random key for encryption
    ...
    "BODY_CLASS" => "hold-transition layout-fixed accent-info",
    "SIDEBAR_CLASS" => "main-sidebar sidebar-light-info",
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-info navbar-dark",
    ...
    "ALLOW_LOGIN_BY_SESSION" => true, // Allow login by session variables
    ...
    // Email
    "SENDER_EMAIL" => "admin@bsd.local", // Sender email address
    ...
    "MAX_FILE_SIZE" => 5000000, // Max file size
